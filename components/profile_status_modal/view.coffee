...
#
# Modal view to prompt a user to change her profile to public
...
#
module.exports = class ProfileStatusModal extends ModalView

  template: (data) -> template data

  className: 'profile-status-modal'
  ...
  makePublic: ->
    mediator.trigger 'profile:make:public'
    @close()
    false
