...
(function() {
  var ARTSY_URL, Backbone, Q, parse, _;
    ...
    fetchUntilEndInParallel: function(options) {
      ...
      options.success = (function(_this) {
        return function(collection, response, opts) {
          var remaining, total, _ref, _ref1, _ref2;
          total = parseInt((opts != null ? (_ref = opts.res) != null ? (_ref1 = _ref.headers) != null ? _ref1['x-total-count'] : void 0 : void 0 : void 0) || (opts != null ? (_ref2 = opts.xhr) != null ? typeof _ref2.getResponseHeader === "function" ? _ref2.getResponseHeader('X-Total-Count') : void 0 : void 0 : void 0) || 0);
          if (response.length >= total) {
            ...
            return Q.allSettled(_.times(remaining, function(n) {
              ...
              dfd.reject(_this);
              return typeof error === "function" ? error(_this) : void 0;
            }).done();
          }
        };
      })(this);
