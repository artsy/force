      ...
      return this.fetchSetsAndItems({
        success: (function(_this) {
          return function(setItems) {
            var allItemsLen, callback, err, items, orderedSet, sale, sets, _i, _len, _ref;
            ...
            for (_i = 0, _len = setItems.length; _i < _len; _i++) {
              _ref = setItems[_i], orderedSet = _ref.orderedSet, items = _ref.items;
      ...
      return sets.fetch({
        ...
        success: (function(_this) {
          return function(sets) {
            var err, error, orderedSet, success, _i, _len, _ref, _results;
            err = null;
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              orderedSet = _ref[_i];
              _results.push(_this.fetchSet(orderedSet, sets, finalHashes, success, error));
            }
            return _results;
          };
        })(this)
