...
template = require('jade').compileFile(require.resolve '../../templates/at_the_fair.jade')
testStubs =
  asset: (->)
  resize: sinon.stub()
  embedVideo: sinon.stub()
  moment: require('moment')
  sd: {CURRENT_PATH: '/info2/artsy-at-the-fair'}
  markdown: (->)
...
describe 'At the Fair templates', ->
  before ->
