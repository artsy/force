...
describe 'Meta tags', ->
  describe 'browse page', ->
    before ->
      @file = "#{process.cwd()}/apps/browse2/templates/meta.jade"
    ...
    it 'includes mobile alternate, canonical, twitter card and og tags', ->
      @html.should.containEql "<link rel=\"alternate\" media=\"mobile-media-query\" href=\"http://m.localhost:5000/browse2"
      @html.should.containEql "<meta property=\"twitter:card\" content=\"summary"
      @html.should.containEql "<meta property=\"og:url\" content=\"http://localhost:5000/browse2"
