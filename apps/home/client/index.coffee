...
module.exports.init = ->
  ...
  new FeaturedLinks().fetchSetItemsByKey 'homepage:featured-sections', success: (links) ->
    $('#home-top-featured-links').html featuredLinksTemplate(featuredLinks: links.models)
