...
module.exports = class PersonalizeState extends Backbone.Model
  defaults:
    ...
    __steps__:
      ...
      new_3: ['collect', 'price_range', 'bookmarks', 'artists', 'galleries', 'institutions', 'introduction']
      ...
      existing_3: ['collect', 'price_range', 'bookmarks', 'artists', 'galleries', 'institutions', 'introduction']
