...
# you need to configure a CNAME record so that $NAME.artsy.net points to nginx-staging-2025.artsy.net
#
echo "Create a CNAME record of $NAME.artsy.net pointing to nginx-staging-2025.artsy.net"
#
