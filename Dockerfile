...
# ---------------------------------------------------------
FROM node:12.20-alpine as builder-base
...
# ---------------------------------------------------------
FROM node:12.20-stretch-slim as electron-runner
...
CMD ["node", "--max_old_space_size=3072", "--heapsnapshot-signal=USR2", "./server.dist.js"]
