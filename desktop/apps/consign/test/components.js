...
describe('React components', () => {
  ...
  describe('StepMarker', () => {
    describe('non-logged-in user', () => {
      ...
      it('updates the color of step labels', () => {
        ...
        const rendered = wrapper.render()
        rendered.find('.consignments-step-marker__step_active').length.should.eql(1)
  ...
  describe('UploadedImage', () => {
    it('correctly displays the processing state when there are no processing images', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-uploaded-image__progress-wrapper').length.should.eql(0)
    })
    ...
    it('correctly displays the processing state when the image is processing', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-uploaded-image__progress-wrapper').length.should.eql(1)
    })
    ...
    it('correctly displays the error state when the image is errored', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-uploaded-image__progress-wrapper').length.should.eql(0)
      rendered.find('.consignments-submission-uploaded-image__error').length.should.eql(1)
    })
    ...
    it('correctly displays the error state when a different image is errored', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-uploaded-image__progress-wrapper').length.should.eql(0)
      rendered.find('.consignments-submission-uploaded-image__error').length.should.eql(0)
    })
  })
  ...
  describe('UploadPhoto', () => {
    it('disables the submit button when there are no photos and the skip checkbox is not clicked', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-upload-photo__submit-button[disabled]').length.should.eql(1)
    })
    ...
    it('enables the button when the skip upload button is checked', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-upload-photo__submit-button[disabled]').length.should.eql(0)
    })
  ...
  describe('ChooseArtist', () => {
    it('disables the button when there is no input', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-choose-artist__next-button[disabled]').length.should.eql(1)
    })
    ...
    it('enables the button when there is an input', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-choose-artist__next-button[disabled]').length.should.eql(0)
    })
    ...
    it('shows and hides warning message', () => {
      ...
      const rendered = wrapper.render()
      rendered.find('.consignments-submission-choose-artist__not-consigning').length.should.eql(1)
      ...
      newRendered.find('.consignments-submission-choose-artist__not-consigning').length.should.eql(0)
    })
  })
