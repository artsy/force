...
const CreateAccount = rewire('../components/create_account')
const UploadPhoto = rewire('../components/upload_photo')
const SubmissionFlow = rewire('../components/submission_flow')
...
describe('React components', () => {
  ...
  describe('CreateAccount', () => {
    beforeEach(() => {
      CreateAccount.__set__('ForgotPassword', () => (
        <div className="forgot-password" />
      ))
      CreateAccount.__set__('LogIn', () => <div className="log-in" />)
      CreateAccount.__set__('SignUp', () => <div className="sign-up" />)
    })
  ...
  describe('UploadPhoto', () => {
    ...
    describe('with photos', () => {
      beforeEach(() => {
        UploadPhoto.__set__('UploadedImage', () => (
  ...
  describe('SubmissionFlow', () => {
    beforeEach(() => {
      ...
      SubmissionFlow.__set__('stepsConfig', componentMap)
      SubmissionFlow.__set__('StepMarker', () => (
