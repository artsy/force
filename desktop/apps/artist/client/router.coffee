...
OverviewView = require './views/overview'
ArtworkFilterView = require '../../../components/artwork_filter_2/view'
CVView = require './views/cv'
ShowsView = require './views/shows'
ArticlesView = require './views/articles'
RelatedArtistsView = require './views/related_artists'
BiographyView = require './views/biography'
HeaderView = require './views/header'
JumpView = require '../../../components/jump/view'
mediator = require '../../../lib/mediator'
attachCTA = require './cta'
AuctionLots = require '../../../collections/auction_lots'
ArtistAuctionResultsView = require './views/auction_results'
