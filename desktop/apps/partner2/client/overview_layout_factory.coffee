...
HeroShowsCarousel = require '../components/hero_shows_carousel/view'
HeroArtworksCarousel = require '../components/hero_artworks_carousel/view'
ArtistsListView = require '../components/artists_list/view'
ArtistsGridView = require '../components/artists_grid/view'
NewsView = require '../components/news/view'
FixedCellsCountCarousel = require '../components/fixed_cells_count_carousel/view'
ShowsGrid = require '../client/shows_grid'
LocationsView = require '../components/locations/view'
