...
Followable = require '../mixins/followable'
GeneArtists = require '../mixins/gene_artists'
Genes = require '../mixins/genes'
BookmarkedArtists = require '../mixins/bookmarked_artists'
