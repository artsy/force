...
describe('<Layout />', () => {
  ...
  it('default auction with no user', () => {
    ...
    wrapper.find('.auction2-auction-info__title').html().should.containEql('An Auction')
    wrapper.find('.auction2-registration').html().should.containEql('Register to bid')
    wrapper.find('.auction2-my-active-bids').length.should.eql(0)
  })
  ...
  it('live auction, open for pre-bidding', () => {
    ...
    wrapper.find('.auction2-registration').html().should.containEql('Register to bid')
    wrapper.find('.auction2-my-active-bids').length.should.eql(0)
    wrapper.find('.auction2-auction-info__callout').text().should.containEql('Live bidding begins')
  })
  ...
  it('live auction, open for live bidding', () => {
    ...
    wrapper.find('.auction2-my-active-bids').length.should.eql(0)
    wrapper.find('.auction2-auction-info__callout').text().should.containEql('Live bidding now open')
  })
  ...
  it('user with bidder positions', () => {
    ...
    wrapper.find('.auction2-my-active-bids').length.should.equal(1)
  })
  ...
  it('index, registered to bid but auction closed', () => {
    ...
    wrapper.find('.auction2-auction-info__title').text().should.equal('An Auction')
    wrapper.find('.auction2-auction-info__callout').text().should.equal('Auction Closed')
  })
