...
import MyActiveBidsView from '../../../components/my_active_bids/view'
import Backbone from 'backbone'
import { data as sd } from 'sharify'

const template = require('jade').compileFile(require.resolve('../templates/my_active_bids.jade'))
  ...
  describe('my_active_bids', () => {
    ...
    describe('with a user and bids', () => {
      ...
      it('displays an outbid bid status', () => {
        ...
        view.$('.auction2-my-active-bids__bid-button').should.have.lengthOf(1)
        view.$('.auction2-my-active-bids__bid-button').text().should.containEql('Bid')
      })
    })
  })
})
