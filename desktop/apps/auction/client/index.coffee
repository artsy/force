...
ConfirmRegistrationModal = require '../../../components/credit_card/client/confirm_registration'
AuctionArtworksView = require '../../../components/auction_artworks/view'
mediator = require '../../../lib/mediator'
setupClocks = require './clocks'
EmailRegistrationView = require './email_registration'
MyActiveBids = require '../../../components/my_active_bids/view'
AddToCalendar = require '../../../components/add_to_calendar/index'
