...
describe('<Article />', () => {
  ...
  const ArticleTest = require('rewire')('../layouts/Article')
  const { ArticleLayout } = ArticleTest

  const {
    InfiniteScrollArticle,
  } = require('desktop/apps/article/components/InfiniteScrollArticle')
  ...
  it('it mounts backbone views for super articles', () => {
    ...
    ArticleTest.__set__('SuperArticleView', SuperArticleView)
    const rendered = mount(
      <ArticleLayout
        isSuper
        article={article}
