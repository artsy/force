...
describe('Meta template', () => {
  it('contains basic meta tags', () => {
    ...
    html.should.containEql('<link rel="canonical" href="undefined/article/artsy-editorial-slug"/>')
    html.should.containEql('<meta name="description" content="Artsy Editorial is an editorial channel."/>')
    html.should.containEql('<meta property="og:description" content="Artsy Editorial is socially friendly."/>')
    html.should.containEql('<meta property="og:image" content="http://kitten-social.com"/>')
...
describe('Classic meta template', () => {
  it('contains basic meta tags', () => {
    const article = _.extend({}, fixtures.article, {
      ...
      social_description: 'Gallery Insights is a socially friendly team channel.',
      social_image: 'http://kitten-social.com'
    })
    ...
    html.should.containEql('<title>Top Ten Booths at miart 2014</title>')
    html.should.containEql('<link rel="canonical" href="undefined/article/gallery-insights-slug"/>')
    html.should.containEql('<meta property="description" content="Gallery Insights is a team channel."/>')
    html.should.containEql('<meta name="og:description" content="Gallery Insights is a socially friendly team channel."/>')
    html.should.containEql('<meta property="og:image" content="http://kitten-social.com"/>')
    html.should.not.containEql('<meta name="robots" content="noindex"/>')
  })
})
