...
FiltersView = require './views/filters_view'
CountView = require './views/header_count_view'
SortsView = require './views/header_sorts_view'
MasonryView = require '../artwork_masonry/view'
