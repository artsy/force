...
import { once as _once, keys as _keys, uniqueId as _uniqueId, isEmpty as _isEmpty } from 'lodash'
...
Events.stopListening = function (obj, name, callback) {
  console.log('stopListening', name)
