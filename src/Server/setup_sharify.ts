...
sharify.data = _.extend(
  _.pick(
    ...
    "SALESFORCE_AUCTION_MESSAGE_SERVICE_NAME",
    "SALESFORCE_AUCTION_MESSAGE_INSTANCE_URL",
    "SALESFORCE_COLLECTOR_MESSAGE_SERVICE_NAME",
    "SALESFORCE_COLLECTOR_MESSAGE_INSTANCE_URL",
    "SECURE_IMAGES_URL",
