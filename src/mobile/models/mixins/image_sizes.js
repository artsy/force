...
export const ImageSizes = {
  ...
  imageUrlForMaxSize() {
    ...
    for (let size of ['source', 'larger', 'large', 'large_rectangle', 'tall', 'medium', 'square', 'small']) {
  ...
  resizeAndCropForAspectRatio() {
    if (this.get('aspect_ratio') > 1) {
      return this.cropUrlFor({ width: 600, height: 400 }, this.imageUrlForHeight(400) );
    } else {
      return this.cropUrlFor({ width: 400, height: 600 }, this.imageUrlForWidth(600) );
    }
  }
};
