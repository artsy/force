...
module.exports = (InstallShots = (function() {
  InstallShots = class InstallShots extends Backbone.Collection {
    static initClass() {
    ...
    parse(response) {
      return _.filter(response, obj => // filter out images without versions
