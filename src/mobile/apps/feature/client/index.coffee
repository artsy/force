...
itemsTemplate = -> require('../templates/items.pug') arguments...
artworkListTemplate = -> require('../../../components/artwork_list/template.pug') arguments...
featuredItemsTemplate = -> require('../../../components/featured_items/template.pug') arguments...
auctionArtworksTemplate = -> require('../../../components/auction_artwork_list/template.pug') arguments...
videoTemplate = -> require('../../../components/video/template.pug') arguments...
auctionDetailTemplate = -> require('../templates/auction_detail.pug') arguments...
