...
export default function() {
  ...
  $.ajaxSettings.headers = {
    ...
    "X-ACCESS-TOKEN": (sd.CURRENT_USER != null ? sd.CURRENT_USER.accessToken : undefined)
  };

  // Setup inquiry referrer tracking
  const referrerIsArtsy = sd.APP_URL ? (doc.referrer.match(parse(sd.APP_URL).host) != null) : false;
  if (!referrerIsArtsy) {
