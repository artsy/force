  ...
  describe '#step', ->
    ...
    describe 'step', ->
      it 'steps the cycle', ->
        ...
        @$first.attr('style').should.containEql 'z-index: 2; opacity: 1;'
        ...
        @$first.attr('style').should.containEql 'z-index: 1; opacity: 0;'
        @$second.hasClass('is-active').should.be.true()
        @$second.attr('style').should.containEql 'z-index: 2; opacity: 1;'
        ...
        @$first.attr('style').should.containEql 'z-index: 2; opacity: 1;'
        @$second.hasClass('is-active').should.be.false()
        @$second.attr('style').should.containEql 'z-index: 1; opacity: 0;'
