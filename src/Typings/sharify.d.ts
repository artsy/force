declare module "sharify" {
  ...
  namespace sharify {
    ...
    export interface GlobalData {
      ...
      SALESFORCE_AUCTION_MESSAGE_SERVICE_NAME: string
      SALESFORCE_AUCTION_MESSAGE_INSTANCE_URL: string
      SALESFORCE_COLLECTOR_MESSAGE_SERVICE_NAME: string
      SALESFORCE_COLLECTOR_MESSAGE_INSTANCE_URL: string
