...
describe 'Fairs template', ->
  before ->
    ...
    @currentFairs = _.times 2, ->
      fabricate('fair', profile: profile, image: image, id: _.uniqueId(), published: true, has_full_feature: true, has_listing: true, organizer: fabricate('fair_organizer'), end_at: moment().add(11, 'days'), banner_size: 'large')
    @pastFairs = _.times 4, ->
      fabricate('fair', profile: profile, image: image, id: _.uniqueId(), published: true, has_full_feature: true, has_listing: true, organizer: fabricate('fair_organizer'), end_at: moment().subtract(11, 'days'))
    @upcomingFairs = _.times 3, ->
      fabricate('fair', profile: profile, image: image, id: _.uniqueId(), published: true, has_full_feature: true, has_listing: true, organizer: null, end_at: moment().add(11, 'days'))
