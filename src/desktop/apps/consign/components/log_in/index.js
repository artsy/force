...
import { logIn, updateAuthFormStateAndClearError } from "../../client/actions"
...
function LogIn(props) {
  ...
  return (
    <div className={b()}>
      <div className={b("title")}>Log In</div>
      <div className={b("subtitle")}>
        New to Artsy?{" "}
        <span
          className={b("clickable")}
          onClick={() => updateAuthFormStateAndClearErrorAction("signUp")}
        >
          Sign up
        </span>.
      </div>
      <form className={b("form")} onSubmit={handleSubmit(logInAction)}>
        ...
        <div className={b("forgot-password")}>
          <span
            className={b("clickable")}
            onClick={() =>
              updateAuthFormStateAndClearErrorAction("forgotPassword")
            }
          >
            Forgot Password
          </span>
        ...
        <a
          className={b
            .builder()("facebook-button")
            .mix("avant-garde-button")()}
