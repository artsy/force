...
app.get("/series/:seriesSlug/:slug/amp", routes.redirectAMP)
app.get("/series/:seriesSlug/:slug", routes.index)
app.get("/video/:slug/amp", routes.redirectAMP)
...
app.get("/artsy-vanguard-2019/:slug/amp", routes.index)
app.get("/artsy-vanguard-2019/:slug", routes.redirectAMP)
