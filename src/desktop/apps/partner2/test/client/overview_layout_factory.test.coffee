...
describe 'overview_layout_factory', ->
  ...
  _.each ['gallery_three', 'gallery_four', 'gallery_five', 'gallery_six', 'gallery_eight'], (layout) ->
    describe "Gallery with #{layout} layout", ->
      beforeEach ->
        @profile = new Profile fabricate 'partner_profile', full_bio: 'full_bil'
        @partner = new Partner fabricate 'partner', profile_layout: layout, display_artists_section: true
  ...
  _.each ['gallery_one', 'gallery_seven'], (layout) ->
    describe "Gallery with #{layout} layout", ->
      beforeEach ->
        @profile = new Profile fabricate 'partner_profile', full_bio: 'full bio here'
        @partner = new Partner fabricate 'partner', profile_layout: layout
