...
aboutTemplate = -> require('../components/about/index.pug') arguments...
showsTemplate = -> require('../components/fixed_cells_count_carousel/shows.pug') arguments...
fairBoothsTemplate = -> require('../components/fixed_cells_count_carousel/fair_booths.pug') arguments...
articlesTemplate = -> require('../components/fixed_cells_count_carousel/articles.pug') arguments...
