...
describe 'FairBrowseView', ->
  ...
  beforeEach (done) ->
    ...
    benv.setup =>
      ...
      benv.render resolve(__dirname, '../template.pug'), { fair: @fair, sd: {}, _: _, counts: collection.counts, params: new Backbone.Model, _s: _s, filterLabelMap: require '../../../../../components/filter2/dropdown/label_map.coffee' }, =>
