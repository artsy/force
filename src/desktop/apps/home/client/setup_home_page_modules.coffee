...
relatedArtistsAnnotation = -> require('../components/related_artists_context/annotation.pug') arguments ...
popularArtistsTemplate = -> require('../components/popular_artists_context/templates/index.pug') arguments...
auctionTemplate = -> require('../components/auction_context/templates/index.pug') arguments...
fairTemplate = -> require('../components/fair_context/templates/index.pug') arguments...
