...
artworkColumnsTemplate = -> require('../../../../mobile/components/artwork_columns/template.pug') arguments...
template = -> require('../templates/mobile/artist.pug') arguments...
emptyTemplate = -> require('../templates/mobile/empty.pug') arguments...
