...
`)
    ...
    return describe("step", () =>
      it("steps the cycle", function () {
        ...
        this.$first.attr("style").should.equal("z-index: 2; opacity: 1;")
        ...
        this.$first.attr("style").should.equal("z-index: 1; opacity: 0;")
        this.$second.hasClass("is-active").should.be.true()
        this.$second.attr("style").should.equal("z-index: 2; opacity: 1;")
        ...
        return this.$second
          .attr("style")
          .should.equal("z-index: 1; opacity: 0;")
      }))
  })
})
