...
filtersTemplate = -> require('./templates/filters.pug') arguments...
itemsTemplate = -> require('./templates/items.pug') arguments...
headerTemplate = -> require('./templates/header.pug') arguments...
itemTemplate = -> require('./templates/item.pug') arguments...
