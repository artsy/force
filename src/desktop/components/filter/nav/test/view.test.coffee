        ...
        el: $ """
          <nav class="filter-nav filter-artworks-nav">
             ...
             <div class="filter-dropdown is-active">
                ...
                <nav style="">
                  <a data-attr="price_range" data-val="">
                    <span class="filter-dropdown-text">All Works</span>
                    <span class="filter-dropdown-count"></span>
                    <span class="icon-check"></span>
                  </a>
                  <a data-attr="price_range" data-val="-1:1000" class="">
                    <span class="filter-dropdown-text">Under $1,000</span>
                    <span class="filter-dropdown-count"></span>
                    <span class="icon-check"></span>
                  </a>
                  <a data-attr="price_range" data-val="1000:5000" class="is-active">
                    <span class="filter-dropdown-text">$1,000 to $5,000</span>
                    <span class="filter-dropdown-count"></span><span class="icon-check"></span>
                  </a>
                  <a data-attr="price_range" data-val="5000:10000">
                    <span class="filter-dropdown-text">$5,000 to $10,000</span>
                    <span class="filter-dropdown-count"></span><span class="icon-check"></span>
                  </a>
                  <a data-attr="price_range" data-val="10000:50000">
                    <span class="filter-dropdown-text">$10,000 to $50,000</span>
                    span class="filter-dropdown-count"></span>
                    <span class="icon-check"></span>
                  </a>
                  <a data-attr="price_range" data-val="50000:1000000000000">
                    <span class="filter-dropdown-text">Over $50,000</span>
                    <span class="filter-dropdown-count"></span><span class="icon-check"></span>
                  </a>
                  <a data-attr="price_range" data-val="-1:1000000000000">
                    <span class="filter-dropdown-text">All For Sale</span>
                    <span class="filter-dropdown-count">(1228)</span>
                    <span class="icon-check"></span>
                  </a>
                </nav>
             </div>
