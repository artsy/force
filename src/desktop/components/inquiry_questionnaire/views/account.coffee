...
templates =
  register: -> require('../templates/account/register.pug') arguments...
  login: -> require('../templates/account/login.pug') arguments...
  forgot: -> require('../templates/account/forgot.pug') arguments...
