...
describe("FavoritesStatusModalView", () => {
  ...
  describe("#showError", () => {
    ...
    it("handles API param_errors", () => {
      errorHandlingForm.showError("description", {
    ...
    it("handles @errors properties that are a function (that an errors object)", function () {
      errorHandlingForm.errors = () => ({
    ...
    it("handles error messages that are a string", () => {
      errorHandlingForm.errors["Stolen Credit Card"] =
        "You have encountered an error."
      errorHandlingForm.showError("foo", {
