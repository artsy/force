...
templates =
  index: -> require('./templates/index.pug') arguments...
  empty: -> require('./templates/empty.pug') arguments...
  message: -> require('./templates/message.pug') arguments...
  suggestion: (suggestion) -> require('./templates/suggestion.pug') suggestion: suggestion
