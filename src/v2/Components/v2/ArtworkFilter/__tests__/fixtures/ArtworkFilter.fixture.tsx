...
export const ArtworkFilterFixture: ArtworkQueryFilterQueryRawResponse = {
  viewer: {
    filtered_artworks: {
      ...
      pageCursors: {
        around: [
          { cursor: "YXJyYXljb25uZWN0aW9uOi0x", isCurrent: true, page: 1 },
          { cursor: "YXJyYXljb25uZWN0aW9uOjI5", isCurrent: false, page: 2 },
          { cursor: "YXJyYXljb25uZWN0aW9uOjU5", isCurrent: false, page: 3 },
          { cursor: "YXJyYXljb25uZWN0aW9uOjg5", isCurrent: false, page: 4 },
        ],
        first: null,
        last: {
      ...
      pageInfo: { endCursor: "YXJyYXljb25uZWN0aW9uOjI5", hasNextPage: true },
    },
  },
}
