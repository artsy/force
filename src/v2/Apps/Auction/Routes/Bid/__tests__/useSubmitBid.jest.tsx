...
jest.mock("v2/Apps/Auction/Queries/useCreateBidderPosition")
jest.mock("v2/Apps/Auction/Queries/useBidderPosition")
jest.mock("v2/System/Router/useRouter")
jest.mock("v2/Apps/Auction/Components/Form/Utils", () => ({
