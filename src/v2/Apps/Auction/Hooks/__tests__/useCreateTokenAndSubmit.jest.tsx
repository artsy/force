...
import { useRefreshUserData } from "v2/Apps/Auction/Queries/useRefreshUserData"

jest.mock("v2/Components/AddressForm", () => ({
  toStripeAddress: jest.fn(),
}))

jest.mock("v2/Apps/Auction/Queries/useRefreshUserData")
jest.mock("v2/Apps/Auction/Hooks/useAuctionTracking")
jest.mock("v2/Apps/Auction/Queries/useAddCreditCardAndUpdateProfile")
jest.mock("v2/Apps/Auction/Queries/useCreateBidder")
jest.mock("v2/Apps/Auction/Components/Form/Utils/errorMessages", () => ({
