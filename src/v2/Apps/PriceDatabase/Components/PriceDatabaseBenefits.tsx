    ...
    <Flex py={[1, 4]} flexDirection="column">
      ...
      <Section
        ...
        description={
          <>
            <Text variant="sm">
              Get insight into artists you follow with a personalized feed,
              powered by the Artsy Price Database. Available now on iOS and
              Android.
            </Text>
            <DownloadAppBadges
              contextModule={ContextModule.priceDatabaseLanding}
