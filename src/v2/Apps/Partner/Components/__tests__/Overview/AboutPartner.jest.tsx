...
describe("AboutPartner", () => {
  it("renders correctly", () => {
    ...
    expect(wrapper.find("Text").at(1).text()).toEqual(fullBio)
    expect(wrapper.find("Text").at(2).text()).toEqual(website)
    expect(wrapper.find("Text").at(3).text()).toEqual(`VAT ID#: ${vatNumber}`)
