...
jest.mock("v2/Apps/Auction2/Queries/useCreateBidderPosition")
jest.mock("v2/Apps/Auction2/Queries/useBidderPosition")
jest.mock("v2/System/Router/useRouter")
jest.mock("v2/Apps/Auction2/Components/Form/Utils", () => ({
      ...
      describe("BIDDER_NOT_QUALIFIED", () => {
        it("redirects to confirm-registration for user to register", async () => {
          ...
          expect(pushSpy).toHaveBeenCalledWith(
            "/auction2/test-sale/confirm-registration"
          )
        })
      })
