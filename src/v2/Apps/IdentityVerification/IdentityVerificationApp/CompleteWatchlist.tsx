...
export const CompleteWatchlist: React.FC = () => {
  return (
    <AppContainer>
      ...
      <Box px={[2, 3]} mb={6} mt={4}>
        <Box mx="auto" width={[335, "80%"]} maxWidth="400px" textAlign="center">
          ...
          <Sans size="4" color="black100" mt={2}>
            Thank you for completing identity verification. We are reviewing
            your verification result and will update you as soon as possible.
          </Sans>
          <Sans size="4" color="black100" mt={2}>
