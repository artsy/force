import { TransactionDetailsSummaryItem_order$data } from "v2/__generated__/TransactionDetailsSummaryItem_order.graphql"
...
> {
  ...
  getOffer(): TransactionDetailsSummaryItem_order$data["lastOffer"] | null {
