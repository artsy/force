...
describe("Works Route", () => {
  ...
  describe("Artist Series Rail", () => {
    it("Displays artist series rail if data is present", async () => {
    ...
    it("Displays collections as a fallback if artist series data is not present", async () => {
      wrapper = await getWrapper("xl", worksWithoutArtistSeries)
...
const worksWithoutArtistSeries: Works_Test_QueryRawResponse = {
  artist: {
    slug: "slug-of-the-artist",
    artistSeriesConnection: undefined,
