import { Artist2Meta_artist } from "v2/__generated__/Artist2Meta_artist.graphql"
...
import { Artist2MetaCanonicalLinkFragmentContainer as Artist2MetaCanonicalLink } from "./Artist2MetaCanonicalLink"

interface Props {
  artist: Artist2Meta_artist
}

// @ts-expect-error STRICT_NULL_CHECK
type ArtworkNode = Artist2Meta_artist["artworks_connection"]["edges"][0]["node"]
...
export const offersAttributes = (artist: Artist2Meta_artist) => {
  // @ts-expect-error STRICT_NULL_CHECK
...
export const structuredDataAttributes = (artist: Artist2Meta_artist) => {
...
export class Artist2Meta extends Component<Props> {
  renderImageMetaTags() {
  ...
  render() {
    ...
    return (
      <>
        <Artist2MetaCanonicalLink artist={artist} />
...
export const Artist2MetaFragmentContainer = createFragmentContainer(
  Artist2Meta,
  {
    artist: graphql`
