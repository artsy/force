...
export interface Props extends SystemContextProps {
  expanded?: boolean
  auctionResult: Artist2AuctionResultItem_auctionResult
  index: number
  mediator?: Mediator
  lastChild: boolean
...
export const Artist2AuctionResultItem: SFC<Props> = props => {
...
export const Artist2AuctionResultItemFragmentContainer = createFragmentContainer(
  Artist2AuctionResultItem,
  {
