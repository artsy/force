...
import { Artist2AuctionResultItemFragmentContainer as AuctionResultItem } from "./Artist2AuctionResultItem"
...
export const Artist2AuctionResultsRefetchContainer = createRefetchContainer(
