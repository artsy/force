...
import { Artist2ConsignButton_artist } from "v2/__generated__/Artist2ConsignButton_artist.graphql"
...
export interface Artist2ConsignButtonProps {
  artist: Artist2ConsignButton_artist
}

export const Artist2ConsignButton: React.FC<Artist2ConsignButtonProps> = ({
  artist,
}) => {
  ...
  return (
    <>
      <Media at="xs">
        <Artist2ConsignButtonSmall {...props} />
      </Media>
      <Media greaterThan="xs">
        <Artist2ConsignButtonLarge {...props} />
      </Media>
    </>
  )
}
...
export const Artist2ConsignButtonLarge: React.FC<
  Artist2ConsignButtonProps & Tracking
> = props => {
...
export const Artist2ConsignButtonSmall: React.FC<
  Artist2ConsignButtonProps & Tracking
> = props => {
  const { showImage, imageURL, headline, consignURL } = getData(props)
...
export const Artist2ConsignButtonFragmentContainer = createFragmentContainer(
  Artist2ConsignButton,
  {
    artist: graphql`
      fragment Artist2ConsignButton_artist on Artist {
        targetSupply {
          isInMicrofunnel
          isTargetSupply
        }
