...
export type SearchResultsArtworks_QueryRawResponse = {
    readonly viewer: ({
        readonly sidebar: ({
            readonly counts: ({
...
export type SearchResultsArtworks_Query = {
    ...
    readonly rawResponse: SearchResultsArtworks_QueryRawResponse;
};
...
(node as any).hash = 'c0f1daadeae4193a2fe751e5491aa3d3';
export default node;
