...
return {
  ...
  "params": {
    "cacheID": "5fa351a62d7147eca185e42b41003d61",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.collectingInstitution": (v8/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.culturalMaker": (v8/*: any*/),
        ...
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.sale.isAuction": (v10/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.sale.isClosed": (v10/*: any*/),
        ...
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork": (v12/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.counts": (v13/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.counts.bidderPositions": (v14/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.highestBid": (v15/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.highestBid.display": (v8/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.id": (v9/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.lotLabel": (v8/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.openingBid": (v16/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.openingBid.display": (v8/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.saleMessage": (v8/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork": (v12/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.counts": (v13/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.counts.bidder_positions": (v14/*: any*/),
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.highest_bid": (v15/*: any*/),
        ...
        "artist.targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.opening_bid": (v16/*: any*/),
