...
fragment PastAuctions_viewer on Viewer {
  salesConnection(first: 15, published: false, live: false, sort: START_AT_DESC) {
    totalCount
    edges {
      node {
        slug
        ...
        "selections": [
          {
            ...
            "storageKey": "salesConnection(first:15,live:false,published:false,sort:\"START_AT_DESC\")"
          },
          {
            "alias": null,
            "args": (v0/*: any*/),
