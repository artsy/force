...
fragment PastAuctions_viewer on Viewer {
  salesConnection(first: 15, live: false, sort: START_AT_DESC, auctionState: CLOSED) {
    totalCount
    edges {
      node {
        slug
        ...
        "selections": [
          {
            ...
            "storageKey": "salesConnection(auctionState:\"CLOSED\",first:15,live:false,sort:\"START_AT_DESC\")"
          },
          {
            "alias": null,
            "args": (v0/*: any*/),
