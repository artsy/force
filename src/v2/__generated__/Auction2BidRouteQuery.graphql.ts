...
export type Auction2BidRouteQueryVariables = {
    saleID: string;
    artworkID: string;
};
export type Auction2BidRouteQueryResponse = {
    readonly sale: {
...
export type Auction2BidRouteQuery = {
    readonly response: Auction2BidRouteQueryResponse;
    readonly variables: Auction2BidRouteQueryVariables;
};



/*
query Auction2BidRouteQuery(
  $saleID: String!
  $artworkID: String!
) {
  sale(id: $saleID) {
...
return {
  ...
  "params": {
    "cacheID": "9c4113d22a78b87819af232281531fbd",
    "id": null,
    "metadata": {},
    "name": "Auction2BidRouteQuery",
    "operationKind": "query",
    "text": "query Auction2BidRouteQuery(\n  $saleID: String!\n  $artworkID: String!\n) {\n  sale(id: $saleID) {\n    ...Auction2BidRoute_sale\n    id\n  }\n  artwork(id: $artworkID) {\n    ...Auction2BidRoute_artwork\n    id\n  }\n  me {\n    ...Auction2BidRoute_me\n    id\n  }\n}\n\nfragment Auction2BidRoute_artwork on Artwork {\n  slug\n  internalID\n  saleArtwork {\n    ...AuctionLotInfo_saleArtwork\n    minimumNextBid {\n      cents\n    }\n    increments(useMyMaxBid: true) {\n      cents\n      display\n    }\n    sale {\n      internalID\n      bidder {\n        id\n      }\n      slug\n      registrationStatus {\n        qualifiedForBidding\n        id\n      }\n      id\n    }\n    id\n  }\n}\n\nfragment Auction2BidRoute_me on Me {\n  internalID\n  hasQualifiedCreditCards\n}\n\nfragment Auction2BidRoute_sale on Sale {\n  internalID\n  slug\n}\n\nfragment AuctionLotInfo_saleArtwork on SaleArtwork {\n  counts {\n    bidderPositions\n  }\n  lotLabel\n  currentBid {\n    display\n  }\n  artwork {\n    internalID\n    date\n    title\n    image {\n      resized(width: 150, height: 150, version: \"square\") {\n        src\n        srcSet\n        width\n        height\n      }\n    }\n    imageUrl\n    artistNames\n    slug\n    id\n  }\n}\n"
  }
};
})();
(node as any).hash = '7a1d1cff94c96c1a9208a4a97b03afe7';
export default node;
