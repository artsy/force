...
export type Works_artist = {
    ...
    readonly " $fragmentRefs": FragmentRefs<"ArtistTopWorksRail_artist" | "V2ArtistSeriesRail_artist" | "ArtistArtworkFilter_artist">;
...
(node as any).hash = '240b2ffe896032ccd25b70c6b6cce6aa';
export default node;
