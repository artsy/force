...
export type Artist2MetaCanonicalLink_artist = {
    ...
    readonly " $refType": "Artist2MetaCanonicalLink_artist";
};
export type Artist2MetaCanonicalLink_artist$data = Artist2MetaCanonicalLink_artist;
export type Artist2MetaCanonicalLink_artist$key = {
    readonly " $data"?: Artist2MetaCanonicalLink_artist$data;
...
(node as any).hash = '77f1d40beefc72c362efc9dd8fcd39ac';
export default node;
