...
export type useUnsubscribeEmailPreferencesMutationVariables = {
    input: UpdateMyProfileInput;
};
export type useUnsubscribeEmailPreferencesMutationResponse = {
...
export type useUnsubscribeEmailPreferencesMutation = {
    readonly response: useUnsubscribeEmailPreferencesMutationResponse;
    readonly variables: useUnsubscribeEmailPreferencesMutationVariables;
};
