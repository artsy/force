...
export type AuctionArtworksRailArtworks_Test_QueryVariables = {};
export type AuctionArtworksRailArtworks_Test_QueryResponse = {
    readonly sale: {
        readonly " $fragmentRefs": FragmentRefs<"AuctionArtworksRailArtworks_sale">;
    } | null;
};
export type AuctionArtworksRailArtworks_Test_Query = {
    readonly response: AuctionArtworksRailArtworks_Test_QueryResponse;
    readonly variables: AuctionArtworksRailArtworks_Test_QueryVariables;
};
...
return {
  ...
  "params": {
    "cacheID": "5e4393aa592f9363208fa47ead9e45f7",
    "id": null,
    "metadata": {},
    "name": "AuctionArtworksRailArtworks_Test_Query",
    "operationKind": "query",
...
(node as any).hash = 'd6c18a6c287587a1211e506e0423989b';
export default node;
