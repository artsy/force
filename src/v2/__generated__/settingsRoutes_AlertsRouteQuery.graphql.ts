...
export type settingsRoutes_AlertsRouteQueryVariables = {};
export type settingsRoutes_AlertsRouteQueryResponse = {
    readonly me: {
        readonly " $fragmentRefs": FragmentRefs<"SettingsAlertsRoute_me">;
    } | null;
};
export type settingsRoutes_AlertsRouteQuery = {
    readonly response: settingsRoutes_AlertsRouteQueryResponse;
    readonly variables: settingsRoutes_AlertsRouteQueryVariables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "settingsRoutes_AlertsRouteQuery",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    ...
    "name": "settingsRoutes_AlertsRouteQuery",
    "operationKind": "query",
    "text": "query settingsRoutes_AlertsRouteQuery {\n  me {\n    ...SettingsAlertsRoute_me\n    id\n  }\n}\n\nfragment AlertItem_item on SearchCriteria {\n  internalID\n  userAlertSettings {\n    name\n  }\n}\n\nfragment AllAlertsSection_me on Me {\n  savedSearchesConnection(first: 10) {\n    edges {\n      node {\n        internalID\n        ...AlertItem_item\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n\nfragment SettingsAlertsRoute_me on Me {\n  ...AllAlertsSection_me\n}\n"
  }
};
})();
(node as any).hash = '29dd17408fa4b92eb4fb43ba329f5bab';
export default node;
