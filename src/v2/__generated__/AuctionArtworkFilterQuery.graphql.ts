...
export type AuctionArtworkFilterQueryVariables = {
    input?: FilterArtworksInput | null;
};
export type AuctionArtworkFilterQueryResponse = {
    readonly viewer: {
        readonly " $fragmentRefs": FragmentRefs<"AuctionArtworkFilter_viewer">;
    } | null;
};
export type AuctionArtworkFilterQuery = {
    readonly response: AuctionArtworkFilterQueryResponse;
    readonly variables: AuctionArtworkFilterQueryVariables;
};
...
return {
  ...
  "params": {
    "cacheID": "5e6ebd6eca5c6d3fe44b78501f73cbf0",
    "id": null,
    "metadata": {},
    "name": "AuctionArtworkFilterQuery",
    "operationKind": "query",
