...
return {
  ...
  "params": {
    "cacheID": "422c988f9587ac1f6d325c55e42398c2",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "targetSupply.microfunnel.artworksConnection.edges.node.collectingInstitution": (v5/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.culturalMaker": (v5/*: any*/),
        ...
        "targetSupply.microfunnel.artworksConnection.edges.node.sale.isAuction": (v7/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.sale.isClosed": (v7/*: any*/),
        ...
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork": (v8/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.counts": (v9/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.counts.bidderPositions": (v10/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.highestBid": (v11/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.highestBid.display": (v5/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.id": (v6/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.lotLabel": (v5/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.openingBid": (v12/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleArtwork.openingBid.display": (v5/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.saleMessage": (v5/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork": (v8/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.counts": (v9/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.counts.bidder_positions": (v10/*: any*/),
        "targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.highest_bid": (v11/*: any*/),
        ...
        "targetSupply.microfunnel.artworksConnection.edges.node.sale_artwork.opening_bid": (v12/*: any*/),
