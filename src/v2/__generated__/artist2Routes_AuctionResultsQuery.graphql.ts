...
export type artist2Routes_AuctionResultsQueryVariables = {
    artistID: string;
};
export type artist2Routes_AuctionResultsQueryResponse = {
    readonly artist: {
        readonly " $fragmentRefs": FragmentRefs<"Artist2AuctionResultsRoute_artist">;
    } | null;
};
export type artist2Routes_AuctionResultsQuery = {
    readonly response: artist2Routes_AuctionResultsQueryResponse;
    readonly variables: artist2Routes_AuctionResultsQueryVariables;
};



/*
query artist2Routes_AuctionResultsQuery(
  $artistID: String!
) {
  artist(id: $artistID) {
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "artist2Routes_AuctionResultsQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "artist2Routes_AuctionResultsQuery",
    "operationKind": "query",
    "text": "query artist2Routes_AuctionResultsQuery(\n  $artistID: String!\n) {\n  artist(id: $artistID) {\n    ...Artist2AuctionResultsRoute_artist\n    id\n  }\n}\n\nfragment Artist2AuctionResultItem_auctionResult on AuctionResult {\n  title\n  dimension_text: dimensionText\n  organization\n  images {\n    thumbnail {\n      url\n    }\n  }\n  mediumText\n  categoryText\n  description\n  date_text: dateText\n  saleDate\n  boughtIn\n  price_realized: priceRealized {\n    display\n    cents_usd: centsUSD\n  }\n  estimate {\n    display\n  }\n}\n\nfragment Artist2AuctionResultsCount_results on AuctionResultConnection {\n  totalCount\n}\n\nfragment Artist2AuctionResultsRoute_artist on Artist {\n  ...Artist2AuctionResults_artist\n}\n\nfragment Artist2AuctionResults_artist on Artist {\n  slug\n  name\n  auctionResultsConnection(first: 10, sort: DATE_DESC) {\n    ...Artist2AuctionResultsCount_results\n    createdYearRange {\n      startAt\n      endAt\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    pageCursors {\n      ...Pagination_pageCursors\n    }\n    totalCount\n    edges {\n      node {\n        title\n        dimension_text: dimensionText\n        images {\n          thumbnail {\n            url\n          }\n        }\n        description\n        date_text: dateText\n        ...Artist2AuctionResultItem_auctionResult\n        id\n      }\n    }\n  }\n}\n\nfragment Pagination_pageCursors on PageCursors {\n  around {\n    cursor\n    page\n    isCurrent\n  }\n  first {\n    cursor\n    page\n    isCurrent\n  }\n  last {\n    cursor\n    page\n    isCurrent\n  }\n  previous {\n    cursor\n    page\n  }\n}\n"
  }
};
})();
(node as any).hash = 'af593236f2ba1e0ff5f007aa7166606a';
export default node;
