...
fragment Works_partner_2p2tYs on Partner {
  slug
  internalID
  filtered_artworks: filterArtworksConnection(aggregations: $aggregations, first: 30, input: $input) {
    id
    aggregations {
      slice
      counts {
...
(node as any).hash = '4f662ec931ec9a74022a82c5e2185bf1';
export default node;
