/**
 * @generated SignedSource<<b96a27b80e84270de248164c0829b2d3>>
...
export type Offer2TestQuery$variables = {};
export type Offer2TestQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Offer_order">;
  } | null;
};
export type Offer2TestQuery$rawResponse = {
  readonly order: {
...
export type Offer2TestQuery = {
  variables: Offer2TestQuery$variables;
  response: Offer2TestQuery$data;
  rawResponse: Offer2TestQuery$rawResponse;
};
