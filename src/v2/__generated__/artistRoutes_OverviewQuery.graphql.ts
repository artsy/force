...
export type artistRoutes_OverviewQueryRawResponse = {
    readonly artist: ({
...
export type artistRoutes_OverviewQuery = {
    ...
    readonly rawResponse: artistRoutes_OverviewQueryRawResponse;
};
...
(node as any).hash = '24ad6b970f6f65f9173d360588884112';
export default node;
