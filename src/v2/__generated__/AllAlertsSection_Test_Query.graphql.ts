...
export type AllAlertsSection_Test_QueryVariables = {};
export type AllAlertsSection_Test_QueryResponse = {
    readonly me: {
        readonly " $fragmentRefs": FragmentRefs<"AllAlertsSection_me">;
    } | null;
};
export type AllAlertsSection_Test_Query = {
    readonly response: AllAlertsSection_Test_QueryResponse;
    readonly variables: AllAlertsSection_Test_QueryVariables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "AllAlertsSection_Test_Query",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    ...
    "name": "AllAlertsSection_Test_Query",
    "operationKind": "query",
    "text": "query AllAlertsSection_Test_Query {\n  me {\n    ...AllAlertsSection_me\n    id\n  }\n}\n\nfragment AlertItem_item on SearchCriteria {\n  internalID\n  userAlertSettings {\n    name\n  }\n}\n\nfragment AllAlertsSection_me on Me {\n  savedSearchesConnection(first: 10) {\n    edges {\n      node {\n        internalID\n        ...AlertItem_item\n        __typename\n      }\n      cursor\n    }\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n  }\n}\n"
  }
};
})();
(node as any).hash = '86be139849c805362cadd4861bcd079c';
export default node;
