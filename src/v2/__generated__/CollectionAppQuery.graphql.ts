...
fragment Collection_collection_2p2tYs on MarketingCollection {
  ...Header_collection
  description
  headerImage
  slug
  ...
  filtered_artworks: artworksConnection(aggregations: $aggregations, input: $input) {
    id
...
(node as any).hash = '9018bb1a69bf0fff87adfa45ec7d8e85';
export default node;
