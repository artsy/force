...
fragment Collection_collection_1mtcxK on MarketingCollection {
  ...Header_collection
  description
  headerImage
  slug
  ...
  filtered_artworks: artworksConnection(acquireable: $acquireable, aggregations: $aggregations, attributionClass: $attributionClass, atAuction: $atAuction, color: $color, forSale: $forSale, additionalGeneIDs: $additionalGeneIDs, height: $height, inquireableOnly: $inquireableOnly, majorPeriods: $majorPeriods, medium: $medium, offerable: $offerable, page: $page, priceRange: $priceRange, sizes: $sizes, first: 30, sort: $sort, width: $width) {
    id
...
(node as any).hash = '1f7e81f2bcb9d39a7e5514a1e3a3ca28';
export default node;
