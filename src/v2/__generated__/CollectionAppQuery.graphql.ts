...
fragment Collection_collection_3zzj5u on MarketingCollection {
  ...Header_collection
  description
  headerImage
  slug
  ...
  filtered_artworks: artworksConnection(acquireable: $acquireable, aggregations: $aggregations, attributionClass: $attributionClass, atAuction: $atAuction, color: $color, forSale: $forSale, geneIDs: $geneIDs, height: $height, inquireableOnly: $inquireableOnly, majorPeriods: $majorPeriods, medium: $medium, offerable: $offerable, page: $page, priceRange: $priceRange, sizes: $sizes, first: 30, sort: $sort, width: $width) {
    id
...
(node as any).hash = '227d2e9ff4b73783528248d4a5edd958';
export default node;
