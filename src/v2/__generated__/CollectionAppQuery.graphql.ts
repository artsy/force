...
fragment Collection_collection_Xth7w on MarketingCollection {
  ...Header_collection
  description
  headerImage
  slug
  ...
  filtered_artworks: artworksConnection(acquireable: $acquireable, aggregations: $aggregations, attributionClass: $attributionClass, atAuction: $atAuction, colors: $colors, forSale: $forSale, additionalGeneIDs: $additionalGeneIDs, height: $height, inquireableOnly: $inquireableOnly, majorPeriods: $majorPeriods, medium: $medium, offerable: $offerable, page: $page, priceRange: $priceRange, sizes: $sizes, first: 30, sort: $sort, width: $width, locationCities: $locationCities) {
    id
...
(node as any).hash = '758710971636ce4e7964375e1d12841b';
export default node;
