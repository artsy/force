...
return {
  ...
  "params": {
    "cacheID": "46d8e2443526f68e574e5db945887bab",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "gene.filtered_artworks.edges.node.collectingInstitution": (v15/*: any*/),
        "gene.filtered_artworks.edges.node.culturalMaker": (v15/*: any*/),
        ...
        "gene.filtered_artworks.edges.node.sale.isAuction": (v20/*: any*/),
        "gene.filtered_artworks.edges.node.sale.isClosed": (v20/*: any*/),
        ...
        "gene.filtered_artworks.edges.node.saleArtwork": (v21/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.counts": (v22/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.counts.bidderPositions": (v23/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.highestBid": (v24/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.highestBid.display": (v15/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.id": (v16/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.lotLabel": (v15/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.openingBid": (v25/*: any*/),
        "gene.filtered_artworks.edges.node.saleArtwork.openingBid.display": (v15/*: any*/),
        "gene.filtered_artworks.edges.node.saleMessage": (v15/*: any*/),
        "gene.filtered_artworks.edges.node.sale_artwork": (v21/*: any*/),
        "gene.filtered_artworks.edges.node.sale_artwork.counts": (v22/*: any*/),
        "gene.filtered_artworks.edges.node.sale_artwork.counts.bidder_positions": (v23/*: any*/),
        "gene.filtered_artworks.edges.node.sale_artwork.highest_bid": (v24/*: any*/),
        ...
        "gene.filtered_artworks.edges.node.sale_artwork.opening_bid": (v25/*: any*/),
