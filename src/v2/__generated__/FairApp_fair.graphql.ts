...
export type FairApp_fair = {
    ...
    readonly " $fragmentRefs": FragmentRefs<"FairMeta_fair" | "FairOverview_fair" | "FairHeader_fair" | "FairHeaderImage_fair">;
...
(node as any).hash = 'c98f6793e96ac354490d8e55910fb65b';
export default node;
