...
export type SettingsMyCollectionArtworksQueryVariables = {
    page?: number | null | undefined;
};
export type SettingsMyCollectionArtworksQueryResponse = {
    readonly me: {
        readonly " $fragmentRefs": FragmentRefs<"SettingsMyCollectionArtworks_me">;
    } | null;
};
export type SettingsMyCollectionArtworksQuery = {
    readonly response: SettingsMyCollectionArtworksQueryResponse;
    readonly variables: SettingsMyCollectionArtworksQueryVariables;
};



/*
query SettingsMyCollectionArtworksQuery(
  $page: Int
) {
  me {
...
return {
  ...
  "params": {
    "cacheID": "0b7f2f2699578eb3f2d9a3163c6424b8",
    "id": null,
    "metadata": {},
    "name": "SettingsMyCollectionArtworksQuery",
    "operationKind": "query",
...
(node as any).hash = '03d87d96b5801fca2b47b96530d3cfe3';
export default node;
