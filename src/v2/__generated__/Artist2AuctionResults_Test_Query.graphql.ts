...
export type Artist2AuctionResults_Test_QueryVariables = {
    artistID: string;
};
export type Artist2AuctionResults_Test_QueryResponse = {
    readonly artist: {
        readonly " $fragmentRefs": FragmentRefs<"AuctionResults_artist">;
    } | null;
};
export type Artist2AuctionResults_Test_QueryRawResponse = {
    readonly artist: ({
...
export type Artist2AuctionResults_Test_Query = {
    readonly response: Artist2AuctionResults_Test_QueryResponse;
    readonly variables: Artist2AuctionResults_Test_QueryVariables;
    readonly rawResponse: Artist2AuctionResults_Test_QueryRawResponse;
};



/*
query Artist2AuctionResults_Test_Query(
  $artistID: String!
) {
  artist(id: $artistID) {
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "Artist2AuctionResults_Test_Query",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    ...
    "name": "Artist2AuctionResults_Test_Query",
    "operationKind": "query",
    "text": "query Artist2AuctionResults_Test_Query(\n  $artistID: String!\n) {\n  artist(id: $artistID) {\n    ...AuctionResults_artist\n    id\n  }\n}\n\nfragment ArtistAuctionResultItem_auctionResult on AuctionResult {\n  title\n  dimension_text: dimensionText\n  organization\n  images {\n    thumbnail {\n      url\n    }\n  }\n  mediumText\n  categoryText\n  description\n  date_text: dateText\n  saleDate\n  boughtIn\n  price_realized: priceRealized {\n    display\n    cents_usd: centsUSD\n  }\n  estimate {\n    display\n  }\n}\n\nfragment ArtistAuctionResults_artist on Artist {\n  slug\n  name\n  ...AuctionResultHeader_artist\n  auctionResultsConnection(first: 10, sort: DATE_DESC) {\n    ...AuctionResultsCount_results\n    createdYearRange {\n      startAt\n      endAt\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    pageCursors {\n      ...Pagination_pageCursors\n    }\n    totalCount\n    edges {\n      node {\n        title\n        dimension_text: dimensionText\n        images {\n          thumbnail {\n            url\n          }\n        }\n        description\n        date_text: dateText\n        ...ArtistAuctionResultItem_auctionResult\n        id\n      }\n    }\n  }\n}\n\nfragment AuctionResultHeader_artist on Artist {\n  slug\n}\n\nfragment AuctionResultsCount_results on AuctionResultConnection {\n  totalCount\n}\n\nfragment AuctionResults_artist on Artist {\n  ...ArtistAuctionResults_artist\n}\n\nfragment Pagination_pageCursors on PageCursors {\n  around {\n    cursor\n    page\n    isCurrent\n  }\n  first {\n    cursor\n    page\n    isCurrent\n  }\n  last {\n    cursor\n    page\n    isCurrent\n  }\n  previous {\n    cursor\n    page\n  }\n}\n"
  }
};
})();
(node as any).hash = '2def84b00affff372ac4c4c6c02764a3';
export default node;
