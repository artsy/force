/**
 * @generated SignedSource<<c9ade8d6a25fccb94bd1d7ba93ebbbf7>>
...
export type AuctionActiveBidsQuery$variables = {
  slug: string;
};
export type AuctionActiveBidsQuery$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"AuctionActiveBids_me">;
  } | null | undefined;
};
export type AuctionActiveBidsQuery = {
  response: AuctionActiveBidsQuery$data;
  variables: AuctionActiveBidsQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "5734a792ee702b5b0690a6a4ecde5f06",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "me.lotStandings.saleArtwork.sale.isLiveOpenHappened": (v7/*: any*/),
