/**
 * @generated SignedSource<<2dcd09990d6265f8489fd8cd49e943e5>>
...
const node: ConcreteRequest = (function () {
  var v0 = [
    ...
    v14 = ["sort", "atAFair", "soloShow", "isReference", "visibleToPublic"],
    v15 = [
      v3 /*: any*/,
      v4 /*: any*/,
      v5 /*: any*/,
  ...
  return {
          ...
          selections: [
            {
              ...
              selections: [
                v2 /*: any*/,
                {
                  ...
                  selections: v13 /*: any*/,
                  storageKey:
                    'showsConnection(atAFair:false,first:10,isReference:true,soloShow:true,sort:"START_AT_DESC",visibleToPublic:false)',
                },
                {
                  alias: null,
                  args: v8 /*: any*/,
            ...
            },
            {
              ...
              selections: [
                v2 /*: any*/,
                {
                  ...
                  selections: v13 /*: any*/,
                  storageKey:
                    'showsConnection(atAFair:false,first:10,isReference:true,soloShow:false,sort:"START_AT_DESC",visibleToPublic:false)',
                },
                {
                  alias: null,
                  args: v15 /*: any*/,
            ...
            },
            {
              ...
              selections: [
                v2 /*: any*/,
                {
                  ...
                  selections: v13 /*: any*/,
                  storageKey:
                    'showsConnection(atAFair:true,first:10,isReference:true,sort:"START_AT_DESC",visibleToPublic:false)',
                },
                {
                  alias: null,
                  args: v16 /*: any*/,
    ...
    params: {
      cacheID: "2531fe45475651d8eef36cf1bf02dd55",
      id: null,
      metadata: {
        relayTestingSelectionTypeInfo: {
          ...
          "viewer.fairBooths.showsConnection.edges.node.__typename":
            v21 /*: any*/,
          ...
          "viewer.fairBooths.showsConnection.edges.node.partner.__isNode":
            v21 /*: any*/,
          "viewer.fairBooths.showsConnection.edges.node.partner.__typename":
            v21 /*: any*/,
          "viewer.fairBooths.showsConnection.edges.node.partner.href":
            v23 /*: any*/,
          "viewer.fairBooths.showsConnection.edges.node.partner.id":
            v18 /*: any*/,
          "viewer.fairBooths.showsConnection.edges.node.partner.name":
            v23 /*: any*/,
          ...
          "viewer.fairBooths.showsConnection.pageInfo.hasNextPage":
            v26 /*: any*/,
          ...
          "viewer.groupShows.showsConnection.edges.node.__typename":
            v21 /*: any*/,
          ...
          "viewer.groupShows.showsConnection.edges.node.partner.__isNode":
            v21 /*: any*/,
          "viewer.groupShows.showsConnection.edges.node.partner.__typename":
            v21 /*: any*/,
          "viewer.groupShows.showsConnection.edges.node.partner.href":
            v23 /*: any*/,
          "viewer.groupShows.showsConnection.edges.node.partner.id":
            v18 /*: any*/,
          "viewer.groupShows.showsConnection.edges.node.partner.name":
            v23 /*: any*/,
          ...
          "viewer.groupShows.showsConnection.pageInfo.hasNextPage":
            v26 /*: any*/,
          ...
          "viewer.soloShows.showsConnection.edges.node.__typename":
            v21 /*: any*/,
          ...
          "viewer.soloShows.showsConnection.edges.node.partner.__isNode":
            v21 /*: any*/,
          "viewer.soloShows.showsConnection.edges.node.partner.__typename":
            v21 /*: any*/,
          "viewer.soloShows.showsConnection.edges.node.partner.href":
            v23 /*: any*/,
          "viewer.soloShows.showsConnection.edges.node.partner.id":
            v18 /*: any*/,
          "viewer.soloShows.showsConnection.edges.node.partner.name":
            v23 /*: any*/,
          ...
          "viewer.soloShows.showsConnection.pageInfo.hasNextPage":
            v26 /*: any*/,
