/**
 * @generated SignedSource<<5ce475397c230141dd97b4a146b6464f>>
...
export type ViewingRoomStatementRouteTestQuery$variables = {
  slug: string;
};
export type ViewingRoomStatementRouteTestQuery$data = {
  readonly viewingRoom: {
    readonly " $fragmentSpreads": FragmentRefs<"ViewingRoomStatementRoute_viewingRoom">;
  } | null | undefined;
};
export type ViewingRoomStatementRouteTestQuery$rawResponse = {
  readonly viewingRoom: {
...
export type ViewingRoomStatementRouteTestQuery = {
  rawResponse: ViewingRoomStatementRouteTestQuery$rawResponse;
  response: ViewingRoomStatementRouteTestQuery$data;
  variables: ViewingRoomStatementRouteTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ViewingRoomStatementRouteTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "57be4a1e6ac4aebf83702720ec1750e5",
    "id": null,
    "metadata": {
