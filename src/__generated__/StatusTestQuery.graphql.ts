/**
 * @generated SignedSource<<46dd1d98290c519b4fe1e01343c0b897>>
...
export type StatusTestQuery$variables = {};
export type StatusTestQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Status_order">;
  } | null;
};
export type StatusTestQuery$rawResponse = {
  readonly order: {
...
export type StatusTestQuery = {
  rawResponse: StatusTestQuery$rawResponse;
  response: StatusTestQuery$data;
  variables: StatusTestQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "3ad053f4879dca1a36ab7892eea16fe9",
    "id": null,
    "metadata": {
