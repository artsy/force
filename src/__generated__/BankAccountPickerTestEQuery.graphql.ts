/**
 * @generated SignedSource<<0a23b5df88f7b497498e78e268e31129>>
...
export type BankAccountPickerTestEQuery$variables = Record<PropertyKey, never>;
export type BankAccountPickerTestEQuery$data = {
  readonly me: {
...
export type BankAccountPickerTestEQuery$rawResponse = {
  readonly me: {
...
export type BankAccountPickerTestEQuery = {
  rawResponse: BankAccountPickerTestEQuery$rawResponse;
  response: BankAccountPickerTestEQuery$data;
  variables: BankAccountPickerTestEQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "BankAccountPickerTestEQuery",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    "cacheID": "a8eaad1680088c3e386cd3d80b2e6a03",
    "id": null,
    "metadata": {
