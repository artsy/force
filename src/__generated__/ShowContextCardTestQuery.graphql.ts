/**
 * @generated SignedSource<<bc84d22cc6e87a38e7a9ce46436cb697>>
...
export type ShowContextCardTestQuery$variables = Record<PropertyKey, never>;
export type ShowContextCardTestQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"ShowContextCard_show">;
  } | null | undefined;
};
export type ShowContextCardTestQuery = {
  response: ShowContextCardTestQuery$data;
  variables: ShowContextCardTestQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "db4ef54bccf8e4885aa2ec7e82c29a04",
    "id": null,
    "metadata": {
