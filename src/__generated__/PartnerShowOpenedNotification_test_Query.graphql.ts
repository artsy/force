/**
 * @generated SignedSource<<facd7279ce5d1199a2f14a327086e820>>
...
export type PartnerShowOpenedNotification_test_Query$variables = Record<
  PropertyKey,
  never
>
                                          ...
                                          selections: [
                                            {
                                              ...
                                              storageKey:
                                                'cropped(height:450,version:["larger","large"],width:600)',
                                            },
                                          ],
                                          storageKey: null,
                                        },
    ...
    params: {
      ...
      metadata: {
        relayTestingSelectionTypeInfo: {
          ...
          "notificationsConnection.edges.node.item.partner.profile.id":
            v6 /*: any*/,
          "notificationsConnection.edges.node.item.partner.profile.internalID":
            v6 /*: any*/,
          ...
          "notificationsConnection.edges.node.item.showsConnection.edges.node.coverImage.cropped.src":
            v5 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.coverImage.cropped.srcSet":
            v5 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.description":
            v7 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.endAt":
            v7 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.exhibitionPeriod":
            v7 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.href":
            v7 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.id":
            v6 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.internalID":
            v6 /*: any*/,
          ...
          "notificationsConnection.edges.node.item.showsConnection.edges.node.location.city":
            v7 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.location.id":
            v6 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.name":
            v7 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.slug":
            v6 /*: any*/,
          "notificationsConnection.edges.node.item.showsConnection.edges.node.startAt":
            v7 /*: any*/,
