/**
 * @generated SignedSource<<f6e47156fbc2f81b3acc8c585573033c>>
...
export type FairOrganizerAppTestQuery$variables = Record<PropertyKey, never>;
export type FairOrganizerAppTestQuery$data = {
  readonly fairOrganizer: {
    readonly " $fragmentSpreads": FragmentRefs<"FairOrganizerApp_fairOrganizer">;
  } | null | undefined;
};
export type FairOrganizerAppTestQuery = {
  response: FairOrganizerAppTestQuery$data;
  variables: FairOrganizerAppTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "FairOrganizerAppTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "9a3c274e065cb26c9b900e30e719369b",
    "id": null,
    "metadata": {
