/**
 * @generated SignedSource<<26d3e0ce727759ffad102835bd8b3fc8>>
...
export type StatusEQuery$variables = Record<PropertyKey, never>;
export type StatusEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Status_order">;
  } | null | undefined;
};
export type StatusEQuery$rawResponse = {
  readonly order: {
...
export type StatusEQuery = {
  rawResponse: StatusEQuery$rawResponse;
  response: StatusEQuery$data;
  variables: StatusEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "e6ed2b46010ff2cd0ce5c50e274b6230",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "order.code": (v15/*: any*/),
        "order.creditCardWalletType": (v16/*: any*/),
        ...
        "order.lineItems.edges.node.artworkVersion.image.resized.url": (v15/*: any*/),
