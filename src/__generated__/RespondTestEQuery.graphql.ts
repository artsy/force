/**
 * @generated SignedSource<<281781801b33469a74eed1183ffa12f9>>
...
export type RespondTestEQuery$variables = Record<PropertyKey, never>;
export type RespondTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Respond_order">;
  } | null | undefined;
};
export type RespondTestEQuery$rawResponse = {
  readonly order: {
...
export type RespondTestEQuery = {
  rawResponse: RespondTestEQuery$rawResponse;
  response: RespondTestEQuery$data;
  variables: RespondTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "44be411fabc3d665316765dc3d92e1fe",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "order.code": (v20/*: any*/),
        "order.creditCardWalletType": (v21/*: any*/),
        ...
        "order.lineItems.edges.node.artworkVersion.image.resized.url": (v20/*: any*/),
