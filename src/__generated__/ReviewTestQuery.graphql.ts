/**
 * @generated SignedSource<<d2c4382bfe6a8b484eeb0400d4ae087a>>
...
export type CommerceOrderSourceEnum =
  ...
  | "private_sale"
  | "%future added value"
export type CommerceOrderStateEnum =
  | "ABANDONED"
  | "APPROVED"
  | "CANCELED"
  | "FULFILLED"
  ...
  | "SUBMITTED"
  | "%future added value"
export type CommercePaymentMethodEnum =
  | "CREDIT_CARD"
  | "SEPA_DEBIT"
  | "US_BANK_ACCOUNT"
  | "WIRE_TRANSFER"
                              ...
                              readonly artworkVersion:
                                | {
                                    ...
                                    readonly attributionClass:
                                      ...
                                      | null
                                      | undefined
                                    readonly condition_description:
                                      | string
                                      | null
                                      | undefined
    ...
    params: {
      ...
      metadata: {
        relayTestingSelectionTypeInfo: {
          ...
          "order.lineItems.edges.node.artwork.editionSets.dimensions":
            v28 /*: any*/,
          "order.lineItems.edges.node.artwork.editionSets.dimensions.cm":
            v22 /*: any*/,
          "order.lineItems.edges.node.artwork.editionSets.dimensions.in":
            v22 /*: any*/,
          "order.lineItems.edges.node.artwork.editionSets.id": v23 /*: any*/,
          "order.lineItems.edges.node.artwork.editionSets.internalID":
            v23 /*: any*/,
          ...
          "order.lineItems.edges.node.artworkVersion.attributionClass.id":
            v23 /*: any*/,
          "order.lineItems.edges.node.artworkVersion.attributionClass.shortDescription":
            v22 /*: any*/,
          "order.lineItems.edges.node.artworkVersion.condition_description":
            v22 /*: any*/,
          "order.lineItems.edges.node.artworkVersion.date": v22 /*: any*/,
          "order.lineItems.edges.node.artworkVersion.dimensions": v28 /*: any*/,
          "order.lineItems.edges.node.artworkVersion.dimensions.cm":
            v22 /*: any*/,
          "order.lineItems.edges.node.artworkVersion.dimensions.in":
            v22 /*: any*/,
          ...
          "order.lineItems.edges.node.selectedShippingQuote.price":
            v22 /*: any*/,
          ...
          "order.requestedFulfillment.__isCommerceRequestedFulfillmentUnion":
            v21 /*: any*/,
