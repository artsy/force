/**
 * @generated SignedSource<<891dc69e965c0a9132f04c9ea07ab80d>>
...
export type ArtistWorksForSaleRailTestQuery$variables = Record<PropertyKey, never>;
export type ArtistWorksForSaleRailTestQuery$data = {
  readonly artist: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistWorksForSaleRail_artist">;
  } | null | undefined;
};
export type ArtistWorksForSaleRailTestQuery = {
  response: ArtistWorksForSaleRailTestQuery$data;
  variables: ArtistWorksForSaleRailTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ArtistWorksForSaleRailTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "34a57370cdc8eb3536a5b9b04d162b0a",
    "id": null,
    "metadata": {
