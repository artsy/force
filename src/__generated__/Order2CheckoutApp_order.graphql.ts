/**
 * @generated SignedSource<<d751c55a694ebf1eeb3341633d4e1d82>>
...
export type Order2CheckoutApp_order$data = {
  ...
  readonly " $fragmentSpreads": FragmentRefs<"Order2CheckoutLoadingSkeleton_order" | "Order2CollapsibleOrderSummary_order" | "Order2DeliveryOptionsStep_order" | "Order2ExpressCheckout_order" | "Order2FulfillmentDetailsStep_order" | "Order2HelpLinks_order" | "Order2OfferStep_order" | "Order2PaymentStep_order" | "Order2ReviewStep_order" | "useCompleteFulfillmentDetailsData_order" | "useLoadCheckout_order">;
...
(node as any).hash = "d1e85943241cccb0125cf89a405bf499";
