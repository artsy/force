/**
 * @generated SignedSource<<d2e6da61f72caab72f1b94a55b47090c>>
...
export type CounterTestEQuery$variables = Record<PropertyKey, never>;
export type CounterTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Counter_order">;
  } | null | undefined;
};
export type CounterTestEQuery$rawResponse = {
  readonly order: {
...
export type CounterTestEQuery = {
  rawResponse: CounterTestEQuery$rawResponse;
  response: CounterTestEQuery$data;
  variables: CounterTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "3e1a34f7668d89f7d8c7a63452f63043",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "order.code": (v19/*: any*/),
        "order.creditCardWalletType": (v20/*: any*/),
        ...
        "order.lineItems.edges.node.artworkVersion.image.resized.url": (v19/*: any*/),
        ...
        "order.lineItems.edges.node.shippingQuoteOptions.edges.node.isSelected": (v26/*: any*/),
        "order.mode": {
          "enumValues": [
            "BUY",
            "OFFER"
