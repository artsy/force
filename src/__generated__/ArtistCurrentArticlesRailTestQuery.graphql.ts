/**
 * @generated SignedSource<<cdb4bbf857d4944cff5a534bf9a17042>>
...
export type ArtistCurrentArticlesRailTestQuery$variables = Record<PropertyKey, never>;
export type ArtistCurrentArticlesRailTestQuery$data = {
  readonly artist: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistCurrentArticlesRail_artist">;
  } | null | undefined;
};
export type ArtistCurrentArticlesRailTestQuery = {
  response: ArtistCurrentArticlesRailTestQuery$data;
  variables: ArtistCurrentArticlesRailTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ArtistCurrentArticlesRailTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "88970a1c106d3e9653fb919b018c4e3a",
    "id": null,
    "metadata": {
