...
export type auctionsRoutes_Artworks_AuctionsQuery$variables = Record<
  PropertyKey,
  never
>
          ...
          selections: [
            {
              ...
              storageKey:
                'salesConnection(auctionState:"OPEN",first:10,live:true,published:true,sort:"TIMELY_AT_NAME_ASC")',
            },
          ],
          storageKey: null,
        },
