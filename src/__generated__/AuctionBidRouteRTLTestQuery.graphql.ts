/**
 * @generated SignedSource<<cdc89cdaad6aa3326e1580e5464f4b8e>>
...
export type AuctionBidRouteRTLTestQuery$variables = Record<PropertyKey, never>;
export type AuctionBidRouteRTLTestQuery$data = {
  readonly artwork: {
...
export type AuctionBidRouteRTLTestQuery = {
  response: AuctionBidRouteRTLTestQuery$data;
  variables: AuctionBidRouteRTLTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "AuctionBidRouteRTLTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "f27940876a4acfa9f8df567dccaf0bb8",
    "id": null,
    "metadata": {
