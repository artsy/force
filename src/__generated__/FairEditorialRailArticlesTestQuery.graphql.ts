/**
 * @generated SignedSource<<8b09cd1fb1793b53ebbbddf7a42713ed>>
...
export type FairEditorialRailArticlesTestQuery$variables = Record<PropertyKey, never>;
export type FairEditorialRailArticlesTestQuery$data = {
  readonly fair: {
    readonly " $fragmentSpreads": FragmentRefs<"FairEditorialRailArticles_fair">;
  } | null | undefined;
};
export type FairEditorialRailArticlesTestQuery = {
  response: FairEditorialRailArticlesTestQuery$data;
  variables: FairEditorialRailArticlesTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "FairEditorialRailArticlesTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "6cb106fede7d6d7bd6eddee292924309",
    "id": null,
    "metadata": {
