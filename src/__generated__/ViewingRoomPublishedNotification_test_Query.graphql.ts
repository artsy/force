...
export type ViewingRoomPublishedNotification_test_Query$variables = Record<
  PropertyKey,
  never
>
    ...
    params: {
      ...
      metadata: {
        relayTestingSelectionTypeInfo: {
          ...
          "notificationsConnection.edges.node.item.viewingRoomsConnection.edges.node.href":
            v6 /*: any*/,
          ...
          "notificationsConnection.edges.node.item.viewingRoomsConnection.edges.node.image.height":
            v7 /*: any*/,
          ...
          "notificationsConnection.edges.node.item.viewingRoomsConnection.edges.node.image.imageURLs.normalized":
            v6 /*: any*/,
          "notificationsConnection.edges.node.item.viewingRoomsConnection.edges.node.image.width":
            v7 /*: any*/,
          "notificationsConnection.edges.node.item.viewingRoomsConnection.edges.node.internalID":
            v5 /*: any*/,
          "notificationsConnection.edges.node.item.viewingRoomsConnection.edges.node.introStatement":
            v6 /*: any*/,
          "notificationsConnection.edges.node.item.viewingRoomsConnection.edges.node.title":
            v4 /*: any*/,
