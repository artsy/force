/**
 * @generated SignedSource<<8ee1f171f01094647a5deb531d0fb88b>>
...
export type RejectTestEQuery$variables = Record<PropertyKey, never>;
export type RejectTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Reject_order">;
  } | null | undefined;
};
export type RejectTestEQuery$rawResponse = {
  readonly order: {
...
export type RejectTestEQuery = {
  rawResponse: RejectTestEQuery$rawResponse;
  response: RejectTestEQuery$data;
  variables: RejectTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "57a5a7364323560f6da27f29b472e8a6",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "order.lineItems.edges.node.artworkVersion.image.resized.url": (v7/*: any*/),
