/**
 * @generated SignedSource<<589718fed4f579a57e24d3415c1b6a65>>
...
export type OrderDetailsPricingBreakdownTestQuery$variables = Record<PropertyKey, never>;
export type OrderDetailsPricingBreakdownTestQuery$data = {
  readonly me: {
    readonly order: {
...
export type OrderDetailsPricingBreakdownTestQuery = {
  response: OrderDetailsPricingBreakdownTestQuery$data;
  variables: OrderDetailsPricingBreakdownTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "OrderDetailsPricingBreakdownTestQuery",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    "cacheID": "592ba083cbde3e38f128e2656a4ac201",
    "id": null,
    "metadata": {
    ...
    "name": "OrderDetailsPricingBreakdownTestQuery",
    "operationKind": "query",
    "text": "query OrderDetailsPricingBreakdownTestQuery {\n  me {\n    order(id: \"test-order\") {\n      ...OrderDetailsPricingBreakdown_order\n      id\n    }\n    id\n  }\n}\n\nfragment OrderDetailsPricingBreakdown_order on Order {\n  mode\n  source\n  pricingBreakdownLines {\n    __typename\n    ... on ShippingLine {\n      displayName\n      amountFallbackText\n      amount {\n        amount\n        currencySymbol\n      }\n    }\n    ... on TaxLine {\n      displayName\n      amountFallbackText\n      amount {\n        amount\n        currencySymbol\n      }\n    }\n    ... on SubtotalLine {\n      displayName\n      amount {\n        amount\n        currencySymbol\n      }\n    }\n    ... on TotalLine {\n      displayName\n      amountFallbackText\n      amount {\n        display\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "e1ab14c743374a86e9bc2b658f222e93";
