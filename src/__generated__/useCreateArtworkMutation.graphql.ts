...
export type ArtworkAttributionClassType =
  | "LIMITED_EDITION"
  | "OPEN_EDITION"
  | "UNIQUE"
  | "UNKNOWN_EDITION"
  | "%future added value"
export type ArtworkConditionEnumType =
  | "EXCELLENT"
  | "FAIR"
  | "GOOD"
  | "VERY_GOOD"
  | "%future added value"
export type ArtworkImportSource =
  | "CONVECTION"
  | "MY_COLLECTION"
  | "%future added value"
export type ArtworkSignatureTypeEnum =
...
export type MyCollectionCreateArtworkInput = {
  ...
  artists?:
    | ReadonlyArray<MyCollectionArtistInput | null | undefined>
    | null
    | undefined
  ...
  signatureTypes?:
    | ReadonlyArray<ArtworkSignatureTypeEnum | null | undefined>
    | null
    | undefined
