...
export type CommerceOrderFulfillmentTypeEnum =
  | "PICKUP"
  | "SHIP"
  | "SHIP_ARTA"
  | "%future added value"
export type CommerceShippingAddressVerifiedByEnum =
  | "ARTSY"
  | "USER"
  | "%future added value"
...
const node: ConcreteRequest = (function () {
  ...
  return {
    ...
    params: {
      cacheID: "3b45874c0022eb66a5075b08d8900f7c",
      id: null,
      metadata: {},
      name: "useSaveFulfillmentDetailsMutation",
