/**
 * @generated SignedSource<<d778e2d11d18f7f3fde6140772e014bd>>
...
export type ShowViewingRoomTestQuery$variables = Record<PropertyKey, never>;
export type ShowViewingRoomTestQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"ShowViewingRoom_show">;
  } | null | undefined;
};
export type ShowViewingRoomTestQuery = {
  response: ShowViewingRoomTestQuery$data;
  variables: ShowViewingRoomTestQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "1e2cff1ebd3e09b7b2f1d7226a02dea3",
    "id": null,
    "metadata": {
    ...
    "name": "ShowViewingRoomTestQuery",
    "operationKind": "query",
    "text": "query ShowViewingRoomTestQuery {\n  show(id: \"example-show-id\") {\n    ...ShowViewingRoom_show\n    id\n  }\n}\n\nfragment ShowViewingRoom_show on Show {\n  partner {\n    __typename\n    ... on Partner {\n      name\n    }\n    ... on ExternalPartner {\n      name\n      id\n    }\n    ... on Node {\n      __isNode: __typename\n      id\n    }\n  }\n  viewingRoomsConnection {\n    edges {\n      node {\n        internalID\n        slug\n        status\n        distanceToOpen(short: true)\n        distanceToClose(short: true)\n        title\n        href\n        image {\n          imageURLs {\n            normalized\n          }\n        }\n      }\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "efaba0c5dd6f87a7e7eea9c956752a30";
