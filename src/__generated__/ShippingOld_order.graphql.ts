/**
 * @generated SignedSource<<abd1807829df4633bc841b63cca1bfe5>>
...
export type ShippingOld_order$data = {
  ...
  readonly " $fragmentType": "ShippingOld_order";
};
export type ShippingOld_order$key = {
  readonly " $data"?: ShippingOld_order$data;
  readonly " $fragmentSpreads": FragmentRefs<"ShippingOld_order">;
};
...
(node as any).hash = "e4c00f4c4e155c8ec3525afa1cc6c9de";
