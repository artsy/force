/**
 * @generated SignedSource<<12a931e3165f67a7ef8d9bfea34988c1>>
...
export type OfferHistoryItemTestEQuery$variables = Record<PropertyKey, never>;
export type OfferHistoryItemTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"OfferHistoryItem_order">;
  } | null | undefined;
};
export type OfferHistoryItemTestEQuery$rawResponse = {
  readonly order: {
...
export type OfferHistoryItemTestEQuery = {
  rawResponse: OfferHistoryItemTestEQuery$rawResponse;
  response: OfferHistoryItemTestEQuery$data;
  variables: OfferHistoryItemTestEQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "OfferHistoryItemTestEQuery",
    "selections": [
      {
        "alias": "order",
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "7a39c14ab03abf220eaf9c905ffd330f",
    "id": null,
    "metadata": {
