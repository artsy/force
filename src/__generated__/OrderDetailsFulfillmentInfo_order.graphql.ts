...
export type OrderDetailsFulfillmentInfo_order$data = {
  ...
  readonly " $fragmentType": "OrderDetailsFulfillmentInfo_order";
};
export type OrderDetailsFulfillmentInfo_order$key = {
  readonly " $data"?: OrderDetailsFulfillmentInfo_order$data;
...
(node as any).hash = "1d42ef85ea1391996f04d00d51e3e618";
