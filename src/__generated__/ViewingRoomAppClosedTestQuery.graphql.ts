/**
 * @generated SignedSource<<ab550adf364b3d36d86f9a31600c443a>>
...
export type ViewingRoomAppClosedTestQuery$variables = {
  slug: string;
};
export type ViewingRoomAppClosedTestQuery$data = {
  readonly viewingRoom: {
    readonly " $fragmentSpreads": FragmentRefs<"ViewingRoomApp_viewingRoom">;
  } | null | undefined;
};
export type ViewingRoomAppClosedTestQuery$rawResponse = {
  readonly viewingRoom: {
...
export type ViewingRoomAppClosedTestQuery = {
  rawResponse: ViewingRoomAppClosedTestQuery$rawResponse;
  response: ViewingRoomAppClosedTestQuery$data;
  variables: ViewingRoomAppClosedTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ViewingRoomAppClosedTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "b156bfce1cfc30bbcf1453efba503fca",
    "id": null,
    "metadata": {
