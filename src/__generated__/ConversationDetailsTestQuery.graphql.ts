                  ...
                  selections: [
                    {
                      ...
                      selections: [
                        ...
                        },
                        {
                          ...
                          name: "stateExpiresAt",
                          storageKey:
                            'stateExpiresAt(format:"MMM D, h:mm A zz")',
                        },
                        v2 /*: any*/,
                        {
                          alias: null,
    ...
    params: {
      ...
      metadata: {
        relayTestingSelectionTypeInfo: {
          ...
          "conversation.attachmentsConnection.edges.node.attachments.contentType":
            v5 /*: any*/,
          "conversation.attachmentsConnection.edges.node.attachments.downloadURL":
            v5 /*: any*/,
          "conversation.attachmentsConnection.edges.node.attachments.fileName":
            v5 /*: any*/,
          "conversation.attachmentsConnection.edges.node.attachments.id":
            v6 /*: any*/,
          ...
          "conversation.orderConnection.edges.node.__isCommerceOrder":
            v5 /*: any*/,
          "conversation.orderConnection.edges.node.__typename": v5 /*: any*/,
          "conversation.orderConnection.edges.node.code": v5 /*: any*/,
          "conversation.orderConnection.edges.node.formattedStateExpiresAt":
            v7 /*: any*/,
          ...
          "conversation.orderConnection.edges.node.lastOffer.amount":
            v7 /*: any*/,
          ...
          "conversation.orderConnection.edges.node.lastOffer.from.__typename":
            v5 /*: any*/,
          ...
          "conversation.orderConnection.edges.node.lineItems.edges.node.artwork.id":
            v6 /*: any*/,
          "conversation.orderConnection.edges.node.lineItems.edges.node.id":
            v6 /*: any*/,
          ...
          "conversation.orderConnection.edges.node.stateExpiresAt":
            v7 /*: any*/,
          "conversation.orderConnection.edges.node.stateReason": v7 /*: any*/,
          "conversation.orderConnection.edges.node.stateUpdatedAt":
            v7 /*: any*/,
        },
      },
      name: "ConversationDetailsTestQuery",
