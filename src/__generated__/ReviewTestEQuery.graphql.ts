/**
 * @generated SignedSource<<f41ef668b63ad88042c118b8eaa07c83>>
...
export type ReviewTestEQuery$variables = Record<PropertyKey, never>;
export type ReviewTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Review_order">;
  } | null | undefined;
};
export type ReviewTestEQuery$rawResponse = {
  readonly order: {
...
export type ReviewTestEQuery = {
  rawResponse: ReviewTestEQuery$rawResponse;
  response: ReviewTestEQuery$data;
  variables: ReviewTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "c7913e49d11b669d809265f2d24d9968",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "order.creditCardWalletType": (v23/*: any*/),
        ...
        "order.lineItems.edges.node.artwork.editionSets.framedDimensions": (v29/*: any*/),
        "order.lineItems.edges.node.artwork.editionSets.framedDimensions.cm": (v23/*: any*/),
        "order.lineItems.edges.node.artwork.editionSets.framedDimensions.in": (v23/*: any*/),
        ...
        "order.lineItems.edges.node.artwork.isUnlisted": (v30/*: any*/),
        ...
        "order.myLastOffer.hasDefiniteTotal": (v30/*: any*/),
        ...
        "order.stateExpiresAtFormatted": (v23/*: any*/),
