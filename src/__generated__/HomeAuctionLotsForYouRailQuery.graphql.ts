...
export type HomeAuctionLotsForYouRailQuery$variables = Record<
  PropertyKey,
  never
>
...
const node: ConcreteRequest = (function () {
  ...
  return {
      ...
      selections: [
        {
          ...
          storageKey:
            "artworksForUser(first:20,includeBackfill:true,onlyAtAuction:true)",
        },
      ],
      type: "Query",
      abstractKey: null,
    ...
    params: {
      cacheID: "7e2440ad096ccf19e97e793ab1b68f27",
      id: null,
      metadata: {},
      name: "HomeAuctionLotsForYouRailQuery",
      operationKind: "query",
