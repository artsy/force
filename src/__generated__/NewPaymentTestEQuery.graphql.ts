/**
 * @generated SignedSource<<59ce39633260a3cda4edea310396302c>>
...
export type NewPaymentTestEQuery$variables = Record<PropertyKey, never>;
export type NewPaymentTestEQuery$data = {
  readonly me: {
...
export type NewPaymentTestEQuery$rawResponse = {
  readonly me: {
...
export type NewPaymentTestEQuery = {
  rawResponse: NewPaymentTestEQuery$rawResponse;
  response: NewPaymentTestEQuery$data;
  variables: NewPaymentTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "35f518b10847f8210dd33a415a774591",
    "id": null,
    "metadata": {
      "relayTestingSelectionTypeInfo": {
        ...
        "order.lineItems.edges.node.artworkVersion.image.resized.url": (v30/*: any*/),
