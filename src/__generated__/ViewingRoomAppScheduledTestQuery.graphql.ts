/**
 * @generated SignedSource<<f99a73a98fb45b46ef91909533cc38dc>>
...
export type ViewingRoomAppScheduledTestQuery$variables = {
  slug: string;
};
export type ViewingRoomAppScheduledTestQuery$data = {
  readonly viewingRoom: {
    readonly " $fragmentSpreads": FragmentRefs<"ViewingRoomApp_viewingRoom">;
  } | null | undefined;
};
export type ViewingRoomAppScheduledTestQuery$rawResponse = {
  readonly viewingRoom: {
...
export type ViewingRoomAppScheduledTestQuery = {
  rawResponse: ViewingRoomAppScheduledTestQuery$rawResponse;
  response: ViewingRoomAppScheduledTestQuery$data;
  variables: ViewingRoomAppScheduledTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ViewingRoomAppScheduledTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
  ...
  "params": {
    "cacheID": "c6b35812a0812920571fd4ffa9ff9fde",
    "id": null,
    "metadata": {
