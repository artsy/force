/**
 * @generated SignedSource<<976c6f6989ed1ba6101f8fda7a5ef208>>
...
export type EditListPrivacyModal_Test_Query$variables = Record<PropertyKey, never>;
export type EditListPrivacyModal_Test_Query$data = {
  readonly me: {
    readonly " $fragmentSpreads": FragmentRefs<"CollectorProfileSavesRoute_me">;
  } | null | undefined;
};
export type EditListPrivacyModal_Test_Query = {
  response: EditListPrivacyModal_Test_Query$data;
  variables: EditListPrivacyModal_Test_Query$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "EditListPrivacyModal_Test_Query",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    "cacheID": "3cc62d5204d1352b4266eddeb13883f7",
    "id": null,
    "metadata": {
