/**
 * @generated SignedSource<<d66371d9f6043e7a16cd1d48562be8d0>>
...
export type AcceptTestEQuery$variables = Record<PropertyKey, never>;
export type AcceptTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Accept_order">;
  } | null | undefined;
};
export type AcceptTestEQuery$rawResponse = {
  readonly order: {
...
export type AcceptTestEQuery = {
  rawResponse: AcceptTestEQuery$rawResponse;
  response: AcceptTestEQuery$data;
  variables: AcceptTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "59d67f049a30da5c87095614ecec829f",
    "id": null,
    "metadata": {
