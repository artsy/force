/**
 * @generated SignedSource<<62bff21921d9c0cfb0ce4ca4467739ab>>
...
export type DismissInquiryModalTestQuery$variables = {};
export type DismissInquiryModalTestQuery$data = {
  readonly conversation: {
    readonly " $fragmentSpreads": FragmentRefs<"DismissInquiryModal_conversation">;
  } | null;
};
export type DismissInquiryModalTestQuery = {
  response: DismissInquiryModalTestQuery$data;
  variables: DismissInquiryModalTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "DismissInquiryModalTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "e7745d2baf4ba8116d7e541173a4c3b8",
    "id": null,
    "metadata": {
