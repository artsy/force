/**
 * @generated SignedSource<<d85966b7b901e37127553507513db191>>
...
export type FairOrganizerDedicatedArticlesTestQuery$variables = Record<PropertyKey, never>;
export type FairOrganizerDedicatedArticlesTestQuery$data = {
  readonly fairOrganizer: {
    readonly " $fragmentSpreads": FragmentRefs<"FairOrganizerDedicatedArticles_fairOrganizer">;
  } | null | undefined;
};
export type FairOrganizerDedicatedArticlesTestQuery = {
  response: FairOrganizerDedicatedArticlesTestQuery$data;
  variables: FairOrganizerDedicatedArticlesTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "FairOrganizerDedicatedArticlesTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "7b38ecde1ce25bb010b4f77fb123f942",
    "id": null,
    "metadata": {
