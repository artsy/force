/**
 * @generated SignedSource<<d1ea880f2b6c8061bdaa7b89f52e83f0>>
...
export type ArtistCurrentShowsRailTestQuery$variables = Record<PropertyKey, never>;
export type ArtistCurrentShowsRailTestQuery$data = {
  readonly artist: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistCurrentShowsRail_artist">;
  } | null | undefined;
};
export type ArtistCurrentShowsRailTestQuery = {
  response: ArtistCurrentShowsRailTestQuery$data;
  variables: ArtistCurrentShowsRailTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ArtistCurrentShowsRailTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "71d757ca577b38457a0700e67959f240",
    "id": null,
    "metadata": {
