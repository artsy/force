/**
 * @generated SignedSource<<f5cf9bfaaaf4ef689fc052b5e7b45b5d>>
...
export type ShowArtworksFilterQuery$variables = {
  aggregations?: ReadonlyArray<ArtworkAggregation | null | undefined> | null | undefined;
  input?: FilterArtworksInput | null | undefined;
  slug: string;
};
export type ShowArtworksFilterQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"ShowArtworks_show">;
  } | null | undefined;
};
export type ShowArtworksFilterQuery = {
  response: ShowArtworksFilterQuery$data;
  variables: ShowArtworksFilterQuery$variables;
};
