/**
 * @generated SignedSource<<ceefdb2280c6ecb006c61b8dc8f134bb>>
          ...
          selections: [
            {
              ...
              storageKey:
                'searchConnection(aggregations:["TYPE"],first:1,query:"andy")',
            },
            {
              alias: null,
              args: [
              ...
              storageKey:
                'artworksConnection(aggregations:["TOTAL"],keyword:"andy",size:0)',
            },
          ],
          storageKey: null,
        },
