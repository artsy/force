...
export type useOrder2ExpressCheckoutSetOrderPaymentMutation$variables = {
  input: setOrderPaymentInput;
};
export type useOrder2ExpressCheckoutSetOrderPaymentMutation$data = {
...
export type useOrder2ExpressCheckoutSetOrderPaymentMutation = {
  response: useOrder2ExpressCheckoutSetOrderPaymentMutation$data;
  variables: useOrder2ExpressCheckoutSetOrderPaymentMutation$variables;
};
