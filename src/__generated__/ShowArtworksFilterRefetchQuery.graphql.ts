/**
 * @generated SignedSource<<c7728a19f716fb580bd079012ca6cacb>>
...
export type ShowArtworksFilterRefetchQuery$variables = {
  input?: FilterArtworksInput | null | undefined;
  slug: string;
};
export type ShowArtworksFilterRefetchQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"ShowArtworks_show">;
  } | null | undefined;
};
export type ShowArtworksFilterRefetchQuery = {
  response: ShowArtworksFilterRefetchQuery$data;
  variables: ShowArtworksFilterRefetchQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ShowArtworksFilterRefetchQuery",
    "selections": [
      {
        "alias": null,
        "args": (v2/*: any*/),
