/**
 * @generated SignedSource<<5da1db0f4876703f5a4fb3df927aaeb9>>
...
export type ArtistArticlesRouteTestQuery$variables = Record<PropertyKey, never>;
export type ArtistArticlesRouteTestQuery$data = {
  readonly artist: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtistArticlesRoute_artist">;
  } | null | undefined;
};
export type ArtistArticlesRouteTestQuery = {
  response: ArtistArticlesRouteTestQuery$data;
  variables: ArtistArticlesRouteTestQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "ArtistArticlesRouteTestQuery",
    "selections": [
      {
        "alias": null,
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "8989afb5d9414c167447c580da5a3cfb",
    "id": null,
    "metadata": {
