...
export type SearchAppTestQuery$variables = Record<PropertyKey, never>;
export type SearchAppTestQuery$data = {
  readonly viewer: {
    readonly " $fragmentSpreads": FragmentRefs<"SearchApp_viewer">;
  } | null | undefined;
};
export type SearchAppTestQuery = {
  response: SearchAppTestQuery$data;
  variables: SearchAppTestQuery$variables;
};
...
(node as any).hash = "4dcff89c8e69cf993746f31edeb5d9d6";
