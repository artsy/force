/**
 * @generated SignedSource<<169451c7ad201ceca6d1db8f5ad96308>>
            ...
            },
            {
              ...
              selections: [
                ...
                },
                {
                  ...
                  selections: v11 /*: any*/,
                  storageKey:
                    'cropped(height:683,version:["main","normalized","larger","large"],width:910)',
                },
                {
                  alias: "small",
                  args: [
                  ...
                  selections: v11 /*: any*/,
                  storageKey:
                    'cropped(height:450,version:["main","normalized","larger","large"],width:600)',
                },
              ],
              storageKey: null,
            },
      ...
      selections: [
        {
          ...
          selections: [
            ...
            },
            {
              ...
              selections: v13 /*: any*/,
              storageKey:
                'showsConnection(first:18,sort:"START_AT_ASC",status:"UPCOMING")',
            },
            {
              alias: "currentShows",
              args: [
            ...
            },
            {
              ...
              selections: v13 /*: any*/,
              storageKey:
                'showsConnection(first:18,sort:"END_AT_DESC",status:"CLOSED")',
            },
          ],
          storageKey: null,
        },
