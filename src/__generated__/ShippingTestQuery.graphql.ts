/**
 * @generated SignedSource<<fb6479d0d59ee7cc4fe8c11d9a5b5fb8>>
...
export type CommerceOrderDisplayStateEnum =
  | "ABANDONED"
  | "APPROVED"
  | "CANCELED"
  | "FULFILLED"
...
export type CommerceOrderParticipantEnum =
  | "BUYER"
  | "SELLER"
  | "%future added value"
export type CommerceOrderSourceEnum =
  | "artwork_page"
  | "inquiry"
  | "partner_offer"
  | "private_sale"
  | "%future added value"
export type ShippingTestQuery$variables = Record<PropertyKey, never>
export type ShippingTestQuery$data = {
  readonly me:
    | {
...
export type ShippingTestQuery$rawResponse = {
  readonly me:
    | {
    ...
    | {
        ...
        readonly lastOffer:
          | {
              ...
              readonly fromParticipant:
                | CommerceOrderParticipantEnum
                | null
                | undefined
              readonly id: string
              readonly internalID: string
                    ...
                    | {
                        readonly node:
                          | {
                              readonly artwork:
                                | {
                                    readonly artsyShippingInternational:
                                      | boolean
                                      | null
                                      | undefined
                                    readonly euShippingOrigin:
                                      | boolean
                                      | null
                                      | undefined
                                    readonly id: string
                                    readonly isUnlisted: boolean
                                    readonly onlyShipsDomestically:
                                      | boolean
                                      | null
                                      | undefined
                                    readonly pickupAvailable:
                                      | boolean
                                      | null
                                      | undefined
                                    readonly processWithArtsyShippingDomestic:
                                      | boolean
                                      | null
                                      | undefined
...
export type ShippingTestQuery = {
  rawResponse: ShippingTestQuery$rawResponse
  response: ShippingTestQuery$data
  variables: ShippingTestQuery$variables
}
...
const node: ConcreteRequest = (function () {
  ...
  return {
    ...
    params: {
      cacheID: "c8f9cf93979c2217c3d59af51368a5c8",
      id: null,
      metadata: {
        relayTestingSelectionTypeInfo: {
          ...
          "order.lineItems.edges.node.artwork.artsyShippingInternational":
            v32 /*: any*/,
          ...
          "order.lineItems.edges.node.artwork.onlyShipsDomestically":
            v32 /*: any*/,
          "order.lineItems.edges.node.artwork.pickupAvailable": v32 /*: any*/,
          "order.lineItems.edges.node.artwork.processWithArtsyShippingDomestic":
            v32 /*: any*/,
          ...
          "order.lineItems.edges.node.artworkOrEditionSet.__isNode":
            v24 /*: any*/,
          "order.lineItems.edges.node.artworkOrEditionSet.__typename":
            v24 /*: any*/,
          ...
          "order.lineItems.edges.node.artworkVersion.artistNames":
            v25 /*: any*/,
          ...
          "order.lineItems.edges.node.artworkVersion.image.resized.url":
            v24 /*: any*/,
          ...
          "order.lineItems.edges.node.selectedShippingQuote.typeName":
            v24 /*: any*/,
          ...
          "order.lineItems.edges.node.shippingQuoteOptions.edges.node.priceCents":
            v28 /*: any*/,
          "order.lineItems.edges.node.shippingQuoteOptions.edges.node.typeName":
            v24 /*: any*/,
          "order.mode": {
            enumValues: ["BUY", "OFFER"],
            nullable: true,
            plural: false,
...
;(node as any).hash = "3537e667bd8f220d28966e5e72eba0bc"
