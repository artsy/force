/**
 * @generated SignedSource<<b83e35478e2188366e1033a11b6a10d9>>
...
export type ShowInfoTestQuery$variables = Record<PropertyKey, never>;
export type ShowInfoTestQuery$data = {
  readonly show: {
    readonly " $fragmentSpreads": FragmentRefs<"ShowInfo_show">;
  } | null | undefined;
};
export type ShowInfoTestQuery = {
  response: ShowInfoTestQuery$data;
  variables: ShowInfoTestQuery$variables;
};
