...
export type CommerceBuyerOfferActionEnum =
  | "OFFER_ACCEPTED"
            ...
            | {
                readonly item:
                  | {
                      ...
                      readonly isOfferableFromInquiry?:
                        | boolean
                        | null
                        | undefined
    ...
    selections: [
      ...
      },
      {
        ...
        field: {
          ...
          storageKey:
            '__ConversationMessages_conversation_messagesConnection_connection(sort:"DESC")',
        },
        action: "NONE",
      },
      {
