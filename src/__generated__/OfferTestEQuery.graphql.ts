/**
 * @generated SignedSource<<2ee8d7786fe797315a0d39f4c0e69077>>
...
export type OfferTestEQuery$variables = Record<PropertyKey, never>;
export type OfferTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"Offer_order">;
  } | null | undefined;
};
export type OfferTestEQuery$rawResponse = {
  readonly order: {
...
export type OfferTestEQuery = {
  rawResponse: OfferTestEQuery$rawResponse;
  response: OfferTestEQuery$data;
  variables: OfferTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "78af598981ce8ea3a08836445170f4a1",
    "id": null,
    "metadata": {
