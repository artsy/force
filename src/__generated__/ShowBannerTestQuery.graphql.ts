/**
 * @generated SignedSource<<f4df6decea68c158104e7c2bfa3965f5>>
...
export type ShowBannerTestQuery$variables = Record<PropertyKey, never>;
export type ShowBannerTestQuery$data = {
  readonly partner: {
...
export type ShowBannerTestQuery = {
  response: ShowBannerTestQuery$data;
  variables: ShowBannerTestQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "f86f7b3771dff7d975a8238ca7349bd7",
    "id": null,
    "metadata": {
