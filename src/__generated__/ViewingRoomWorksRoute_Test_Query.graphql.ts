                        ...
                        readonly node:
                          | {
                              ...
                              readonly attributionClass:
                                ...
                                | null
                                | undefined
                              readonly collecting_institution:
                                | string
                                | null
                                | undefined
                                ...
                                | {
                                    readonly auction:
                                      | {
                                          ...
                                          readonly lotClosesAt:
                                            | string
                                            | null
                                            | undefined
                                          readonly onlineBiddingExtended: boolean
                                          readonly registrationEndsAt:
                                            | string
                                            | null
                                            | undefined
                                        }
                              ...
                              readonly sale:
                                | {
                                    readonly cascadingEndTimeIntervalMinutes:
                                      | number
                                      | null
                                      | undefined
                                    readonly endAt: string | null | undefined
                                    readonly extendedBiddingIntervalMinutes:
                                      | number
                                      | null
                                      | undefined
                                    readonly id: string
                              ...
                              readonly sale_artwork:
                                | {
                                    readonly counts:
                                      ...
                                      | undefined
                                    readonly endAt: string | null | undefined
                                    readonly extendedBiddingEndAt:
                                      | string
                                      | null
                                      | undefined
                                    readonly formattedEndDateTime:
                                      | string
                                      | null
                                      | undefined
...
const node: ConcreteRequest = (function () {
  ...
  return {
                        ...
                        },
                        {
                          ...
                          selections: [
                            v2 /*: any*/,
                            {
                              ...
                              selections: v5 /*: any*/,
                              storageKey:
                                'resized(quality:85,version:"normalized",width:600)',
                            },
                            {
                              alias: null,
                              args: [
                              ...
                              selections: v5 /*: any*/,
                              storageKey:
                                'resized(height:550,quality:85,version:"normalized")',
                            },
                          ],
                          storageKey: null,
                        },
    ...
    params: {
      cacheID: "c3cf43fe57e137490ff64f140de25a67",
      id: null,
      metadata: {
        relayTestingSelectionTypeInfo: {
          ...
          "viewingRoom.artworksConnection.edges.node.additionalInformation":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.artist.targetSupply.isP1":
            v16 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.artists.href":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.artists.id": v15 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.artists.name":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.attributionClass.id":
            v15 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.attributionClass.name":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.collecting_institution":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.collectorSignals.auction.liveBiddingStarted":
            v17 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.collectorSignals.auction.lotClosesAt":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.collectorSignals.auction.onlineBiddingExtended":
            v17 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.collectorSignals.auction.registrationEndsAt":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.collectorSignals.partnerOffer.endAt":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.collectorSignals.partnerOffer.id":
            v15 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.collectorSignals.partnerOffer.priceWithDiscount.display":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.cultural_maker":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.images.resized":
            v18 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.resized.height":
            v19 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.resized.src":
            v20 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.resized.srcSet":
            v20 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.resized.width":
            v19 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.solo":
            v18 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.solo.height":
            v19 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.solo.src":
            v20 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.solo.srcSet":
            v20 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.images.solo.width":
            v19 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.mediumType.filterGene.id":
            v15 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.mediumType.filterGene.name":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.partner.href":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.partner.id": v15 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.partner.name":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.sale.cascadingEndTimeIntervalMinutes":
            v19 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale.endAt": v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale.extendedBiddingIntervalMinutes":
            v19 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale.id": v15 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale.is_auction":
            v16 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale.is_closed":
            v16 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale.startAt":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.saleArtwork":
            v21 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.saleArtwork.id":
            v15 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.saleArtwork.lotID":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.sale_artwork.endAt":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale_artwork.extendedBiddingEndAt":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale_artwork.formattedEndDateTime":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.sale_artwork.highest_bid.display":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale_artwork.id":
            v15 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale_artwork.lotID":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale_artwork.lotLabel":
            v14 /*: any*/,
          ...
          "viewingRoom.artworksConnection.edges.node.sale_artwork.opening_bid.display":
            v14 /*: any*/,
          "viewingRoom.artworksConnection.edges.node.sale_message":
            v14 /*: any*/,
