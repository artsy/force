/**
 * @generated SignedSource<<ace2dde863358e8b38081e1068485f3c>>
...
export type SuggestedArtworksModalGrid_Test_Query$variables = Record<
  PropertyKey,
  never
>
...
const node: ConcreteRequest = (function () {
  ...
  return {
      ...
      selections: [
        {
          ...
          storageKey:
            'artworksConnection(first:10,forSale:true,sort:"-published_at")',
        },
      ],
      type: "Query",
      abstractKey: null,
    ...
    params: {
      cacheID: "1469896016813a34d1291806e7d309d4",
      id: null,
      metadata: {
