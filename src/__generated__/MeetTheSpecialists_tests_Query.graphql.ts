/**
 * @generated SignedSource<<22c1acc45ba3492a93911151ae076d1c>>
...
export type MeetTheSpecialists_tests_Query$variables = Record<PropertyKey, never>;
export type MeetTheSpecialists_tests_Query$data = {
  readonly staticContent: {
    readonly " $fragmentSpreads": FragmentRefs<"MeetTheSpecialists_staticContent">;
  } | null | undefined;
};
export type MeetTheSpecialists_tests_Query = {
  response: MeetTheSpecialists_tests_Query$data;
  variables: MeetTheSpecialists_tests_Query$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "MeetTheSpecialists_tests_Query",
    "selections": [
      {
        "alias": null,
        "args": null,
  ...
  "params": {
    "cacheID": "ae769ce0cb62deb6e5bcfbd8499458d6",
    "id": null,
    "metadata": {
    ...
    "name": "MeetTheSpecialists_tests_Query",
    "operationKind": "query",
    "text": "query MeetTheSpecialists_tests_Query {\n  staticContent {\n    ...MeetTheSpecialists_staticContent\n    id\n  }\n}\n\nfragment MeetTheSpecialists_staticContent on StaticContent {\n  specialistBios {\n    name\n    firstName\n    jobTitle\n    bio\n    email\n    image {\n      imageURL\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "ce2a50261947feb6916f94da8e281927";
