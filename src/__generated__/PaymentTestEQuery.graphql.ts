/**
 * @generated SignedSource<<a556745a117bd9d5bc62b3d42691956c>>
...
export type PaymentTestEQuery$variables = Record<PropertyKey, never>;
export type PaymentTestEQuery$data = {
  readonly me: {
...
export type PaymentTestEQuery$rawResponse = {
  readonly me: {
...
export type PaymentTestEQuery = {
  rawResponse: PaymentTestEQuery$rawResponse;
  response: PaymentTestEQuery$data;
  variables: PaymentTestEQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "6d834cfacd4be8f65c057c7db6c441f2",
    "id": null,
    "metadata": {
