/**
 * @generated SignedSource<<dc5b5d3a4dee662e22a06cff966c5d7b>>
...
export type useOrder2SetFulfillmentOptionMutation$variables = {
  input: setOrderFulfillmentOptionInput;
};
export type useOrder2SetFulfillmentOptionMutation$data = {
...
export type useOrder2SetFulfillmentOptionMutation = {
  response: useOrder2SetFulfillmentOptionMutation$data;
  variables: useOrder2SetFulfillmentOptionMutation$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "useOrder2SetFulfillmentOptionMutation",
    "selections": [
      {
        "alias": null,
        "args": (v1/*: any*/),
