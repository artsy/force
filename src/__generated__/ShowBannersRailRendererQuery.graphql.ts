/**
 * @generated SignedSource<<608435a0460806b1510d3a21de7fd1fc>>
                ...
                selections: [
                  {
                    ...
                    storageKey:
                      'cropped(height:480,version:["main","normalized","larger","large"],width:910)',
                  },
                ],
                storageKey: null,
              },
      ...
      selections: [
        {
          ...
          selections: [
            v2 /*: any*/,
            {
              ...
              selections: v5 /*: any*/,
              storageKey:
                'showsConnection(first:1,isDisplayable:true,sort:"FEATURED_DESC_END_AT_DESC",status:"ALL")',
            },
            {
              alias: "currentShows",
              args: [
              ...
              selections: v5 /*: any*/,
              storageKey:
                'showsConnection(first:10,isDisplayable:true,sort:"END_AT_ASC",status:"CURRENT")',
            },
            {
              alias: "upcomingShows",
              args: [
              ...
              selections: v5 /*: any*/,
              storageKey:
                'showsConnection(first:10,isDisplayable:true,sort:"START_AT_ASC",status:"UPCOMING")',
            },
            {
              alias: "pastShows",
              args: [
              ...
              selections: v5 /*: any*/,
              storageKey:
                'showsConnection(first:2,isDisplayable:true,sort:"END_AT_DESC",status:"CLOSED")',
            },
            v4 /*: any*/,
          ],
          storageKey: null,
