/**
 * @generated SignedSource<<636dcafa3346aa926b39d91cb144b2ea>>
...
export type TransactionDetailsSummaryItemTestEQuery$variables = Record<PropertyKey, never>;
export type TransactionDetailsSummaryItemTestEQuery$data = {
  readonly order: {
    readonly " $fragmentSpreads": FragmentRefs<"TransactionDetailsSummaryItem_order">;
  } | null | undefined;
};
export type TransactionDetailsSummaryItemTestEQuery$rawResponse = {
  readonly order: {
...
export type TransactionDetailsSummaryItemTestEQuery = {
  rawResponse: TransactionDetailsSummaryItemTestEQuery$rawResponse;
  response: TransactionDetailsSummaryItemTestEQuery$data;
  variables: TransactionDetailsSummaryItemTestEQuery$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "TransactionDetailsSummaryItemTestEQuery",
    "selections": [
      {
        "alias": "order",
        "args": (v0/*: any*/),
  ...
  "params": {
    "cacheID": "76a3115079b34e164f5865e92267f5bb",
    "id": null,
    "metadata": {
    ...
    "name": "TransactionDetailsSummaryItemTestEQuery",
    "operationKind": "query",
    "text": "query TransactionDetailsSummaryItemTestEQuery {\n  order: commerceOrder(id: \"whatevs\") {\n    __typename\n    ...TransactionDetailsSummaryItem_order\n    id\n  }\n}\n\nfragment TransactionDetailsSummaryItem_order on CommerceOrder {\n  __isCommerceOrder: __typename\n  __typename\n  requestedFulfillment {\n    __typename\n  }\n  code\n  lineItems {\n    edges {\n      node {\n        artworkOrEditionSet {\n          __typename\n          ... on Artwork {\n            price\n          }\n          ... on EditionSet {\n            price\n            id\n          }\n          ... on Node {\n            __isNode: __typename\n            id\n          }\n        }\n        selectedShippingQuote {\n          typeName\n          id\n        }\n        id\n      }\n    }\n  }\n  mode\n  source\n  displayState\n  shippingTotal(precision: 2)\n  shippingTotalCents\n  taxTotal(precision: 2)\n  taxTotalCents\n  itemsTotal(precision: 2)\n  buyerTotal(precision: 2)\n  currencyCode\n  ... on CommerceOfferOrder {\n    lastOffer {\n      internalID\n      amount(precision: 2)\n      amountCents\n      shippingTotal(precision: 2)\n      shippingTotalCents\n      taxTotal(precision: 2)\n      taxTotalCents\n      buyerTotal(precision: 2)\n      buyerTotalCents\n      fromParticipant\n      note\n      id\n    }\n    myLastOffer {\n      internalID\n      amount(precision: 2)\n      amountCents\n      shippingTotal(precision: 2)\n      shippingTotalCents\n      taxTotal(precision: 2)\n      taxTotalCents\n      buyerTotal(precision: 2)\n      buyerTotalCents\n      fromParticipant\n      note\n      id\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "997b1bf835240d68eb5815ad7cc9d244";
