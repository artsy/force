...
export type FollowGeneButtonQueryVariables = {
    id: string;
};
export type FollowGeneButtonQueryResponse = {
    readonly gene: {
        readonly " $fragmentRefs": FragmentRefs<"FollowGeneButton_gene">;
    } | null;
};
export type FollowGeneButtonQuery = {
    readonly response: FollowGeneButtonQueryResponse;
    readonly variables: FollowGeneButtonQueryVariables;
};



/*
query FollowGeneButtonQuery(
  $id: String!
) {
  gene(id: $id) {
