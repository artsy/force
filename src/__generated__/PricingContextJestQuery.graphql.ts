/**
 * @generated SignedSource<<30efa08768b2bce845391c689bcbcb7b>>
...
export type PricingContextJestQuery$variables = Record<PropertyKey, never>;
export type PricingContextJestQuery$data = {
  readonly artwork: {
    readonly " $fragmentSpreads": FragmentRefs<"PricingContext_artwork">;
  } | null | undefined;
};
export type PricingContextJestQuery$rawResponse = {
  readonly artwork: {
...
export type PricingContextJestQuery = {
  rawResponse: PricingContextJestQuery$rawResponse;
  response: PricingContextJestQuery$data;
  variables: PricingContextJestQuery$variables;
};
...
return {
  ...
  "params": {
    "cacheID": "aaffe91ffabe36cbbdac7d24f620bd4a",
    "id": null,
    "metadata": {
    ...
    "name": "PricingContextJestQuery",
    "operationKind": "query",
    "text": "query PricingContextJestQuery {\n  artwork(id: \"unused\") {\n    ...PricingContext_artwork\n    id\n  }\n}\n\nfragment PricingContext_artwork on Artwork {\n  listPrice {\n    __typename\n    ... on PriceRange {\n      maxPrice {\n        minor\n      }\n      minPrice {\n        minor\n      }\n    }\n    ... on Money {\n      minor\n    }\n  }\n  artists(shallow: true) {\n    slug\n    id\n  }\n  category\n  pricingContext {\n    appliedFiltersDisplay\n    appliedFilters {\n      dimension\n      category\n    }\n    bins {\n      maxPrice\n      maxPriceCents\n      minPrice\n      minPriceCents\n      numArtworks\n    }\n  }\n}\n"
  }
};
})();

(node as any).hash = "8a4ee71ed533fa9b258d330c96291ed5";
