...
export type ArtworkImageBrowserLargeTestQuery$variables = Record<PropertyKey, never>;
export type ArtworkImageBrowserLargeTestQuery$data = {
  readonly artwork: {
    readonly " $fragmentSpreads": FragmentRefs<"ArtworkImageBrowserLarge_artwork">;
  } | null | undefined;
};
export type ArtworkImageBrowserLargeTestQuery = {
  response: ArtworkImageBrowserLargeTestQuery$data;
  variables: ArtworkImageBrowserLargeTestQuery$variables;
};
...
(node as any).hash = "3329a5a7f4d0cc8ef1b2e4e05c16f03b";
