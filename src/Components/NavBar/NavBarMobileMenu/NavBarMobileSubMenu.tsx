...
import type { NavBarMobileSubMenu_navigationVersion$key } from "__generated__/NavBarMobileSubMenu_navigationVersion.graphql"

const LETTERS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("")

interface NavBarMobileSubMenuProps {
  navigationVersion: NavBarMobileSubMenu_navigationVersion$key
