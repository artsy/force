...
export const FooterDownloadAppBanner = () => {
  return (
    <Box borderBottom="1px solid" borderColor="black10">
      <GridColumns>
        <Column
          span={4}
          display="flex"
      ...
      <Text variant="xs" fontStyle="italic" textAlign="right" my={1}>
        Nicolas Party, Trees, 2019. Damien Cifelli, May You Live in Interesting
        Times, 2022. Anna Park, It's Good For You, 2020
      </Text>
    </Box>
  )
}
