...
export const CriteriaPills: FC<React.PropsWithChildren<CriteriaPillsProps>> = ({ editable = true }) => {
...
export const CriteriaPillsPlaceholder: FC<React.PropsWithChildren<unknown>> = () => {
  return (
