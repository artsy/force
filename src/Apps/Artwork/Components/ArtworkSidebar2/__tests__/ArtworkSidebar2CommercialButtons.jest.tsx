...
describe("ArtworkSidebar2CommercialButtons", () => {
  let user
  beforeAll(() => {
  ...
  const { renderWithRelay } = setupTestWrapperTL<
    ArtworkSidebar2CommercialButtons_Test_Query
  >({
    Component: ({ artwork }) => (
    ...
    query: graphql`
      query ArtworkSidebar2CommercialButtons_Test_Query @relay_test_operation {
