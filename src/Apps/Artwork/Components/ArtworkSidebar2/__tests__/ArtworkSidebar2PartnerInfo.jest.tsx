...
import { ArtworkSidebar2PartnerInfoFragmentContainer } from "Apps/Artwork/Components/ArtworkSidebar2/ArtworkSidebar2PartnerInfo"
...
const { renderWithRelay } = setupTestWrapperTL({
  Component: (props: any) => (
    <ArtworkSidebar2PartnerInfoFragmentContainer artwork={props.artwork} />
  ),
  query: graphql`
    query ArtworkSidebar2PartnerInfo_Test_Query @relay_test_operation {
...
describe("ArtworkSidebar2PartnerInfo", () => {
  beforeAll(() => {
