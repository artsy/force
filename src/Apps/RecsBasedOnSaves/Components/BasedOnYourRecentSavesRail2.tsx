...
export const BasedOnYourRecentSavesRail2: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchFromReviewMetaphysics(
      ...
      {
        homeView {
          basedOnYourRecentSaves: section(id: "home-view-section-based-on-your-recent-saves-2") {
            component { title }
      ...
      .then(data => {
        ...
        setTitle(
          section?.component?.title ??
            "Based on Your Recent Saves (with visual search)",
        )
        setArtworks(
