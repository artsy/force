...
import { useParseOrderData } from "Apps/Order/Routes/Shipping2/Utils/ShippingContext/useParseOrderData"
import {
  ShippingContextProps,
  ShippingStage,
  State,
} from "Apps/Order/Routes/Shipping2/Utils/ShippingContext/ShippingContext"
import { useShippingContextHelpers } from "Apps/Order/Routes/Shipping2/Utils/ShippingContext/useShippingContextHelpers"

/**
 * Load the full shipping context from its top-level route using relay props.
 */
export const useComputeShippingContext = (
  props: Pick<ShippingProps, "order" | "me" | "dialog">
): ShippingContextProps => {
