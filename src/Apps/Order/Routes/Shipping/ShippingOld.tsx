...
import { ShippingOld_order$data } from "__generated__/ShippingOld_order.graphql"
import {
...
import { ShippingOld_me$data } from "__generated__/ShippingOld_me.graphql"
import {
  startingPhoneNumber,
  startingAddress,
...
export interface ShippingProps {
  order: ShippingOld_order$data
  me: ShippingOld_me$data
  relay?: RelayProp
  router: Router
  dialog: Dialog
...
export const ShippingRoute: FC<ShippingProps> = props => {
  ...
  const [phoneNumberTouched, setPhoneNumberTouched] = useState<
    PhoneNumberTouched
  >(false)
  const addressList: SavedAddressType[] =
...
export const ShippingFragmentContainer = createFragmentContainer(
  ...
  {
    order: graphql`
      fragment ShippingOld_order on CommerceOrder {
        internalID
        mode
        state
