  ...
  return (
    <States<{ id: string }>
      states={[
        ...
        {
          id: "artsy-editorial-artsy-vanguard-2020-hock-aye-vi-edgar-heap-birds",
        },

        { id: "editorial-in-the-studio-with-jr" },
        { id: "artsy-editorial-artsy-vanguard-2021" },
        {
          id: "artsy-editorial-new-generation-black-women-nonbinary-gallerists-redefining-gallery-model",
        },
        ...
        {
          id: "artsy-editorial-behind-the-venice-biennale-2015-a-short-history-of-the-world-s-most-important-art-exhibition",
        },
        {
          id: "artsy-editorial-dale-chihuly-pioneering-glass-artist-building-major-legacy",
        },
        {
          id: "artsy-editorial-midst-covid-19-chinese-galleries-adapt-persevere",
        },
