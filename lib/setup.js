...
import newMarketingSignupModal from '../desktop/components/marketing_signup_modal/middleware'
...
export default function (app) {
  ...
  // This is calling the module that fetches data from s3 and setting the
  // sd and locals object.
  app.use(newMarketingSignupModal)
