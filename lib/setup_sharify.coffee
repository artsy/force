...
sharify.data = _.extend _.pick(config, 'APP_URL', 'POSITRON_URL',
  ...
  'CMS_URL', 'DELTA_HOST', 'ENABLE_AB_TEST', 'KIOSK_PAGE', 'KIOSK_MODE',
  'EMPTY_COLLECTION_SET_ID', 'GEMINI_S3_ACCESS_KEY', 'GEMINI_APP',
  'GEMINI_ACCOUNT_KEY', 'GEMINI_CLOUDFRONT_URL', 'DISABLE_GEMINI_PROXY',
  'BIDDER_H1_COPY', 'BIDDER_H2_COPY', 'SENTRY_PUBLIC_DSN',
  ...
  'GALLERY_INSIGHTS_SLUG', 'GALLERY_INSIGHTS_LIST', 'FUSION_URL',
  'GALAXY_URL', 'GALAXY_PUBLISHABLE_TOKEN', 'MAILCHIMP_WELCOME_LIST_ID', 'MAILCHIMP_AUCTION_LIST_ID'
), {
