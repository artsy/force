...
{ ARTSY_URL, NODE_ENV, ARTSY_ID, ARTSY_SECRET, SESSION_SECRET, SESSION_COOKIE_MAX_AGE, PORT, ASSET_PATH,
  ...
  DELTA_HOST, ENABLE_AB_TEST, KIOSK_MODE, KIOSK_PAGE, SUGGESTIONS_AB_TEST,
  SUGGESTIONS_TEST_GROUP } = config = require "../config"
...
sharify.data =
  ...
  SUGGESTIONS_TEST_GROUP: SUGGESTIONS_TEST_GROUP
