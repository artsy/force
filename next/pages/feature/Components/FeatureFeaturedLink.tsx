...
export const FeatureFeaturedLink: React.FC<FeatureFeaturedLinkProps> = ({
  ...
  const { href, title, subtitle, description, image } = featuredLink
    ...
    <Flex flexDirection="column" {...rest}>
      ...
      {!img && title && (
        <Text variant="title" color="black100" my={2}>
          <RouterLink href={href}>{title || "—"}</RouterLink>
        </Text>
      )}
...
export default createFragmentContainer(FeatureFeaturedLink, {
