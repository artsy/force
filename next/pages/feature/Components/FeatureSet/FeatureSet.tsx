...
import FeatureSetMeta from "./FeatureSetMeta"
import FeatureSetContainer from "./FeatureSetContainer"
import FeatureSetItem from "./FeatureSetItem"
...
export default createFragmentContainer(FeatureSet, {
  set: graphql`
