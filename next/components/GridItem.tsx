...
import SomeLink from "next/link"
...
class ArtworkGridItemContainer extends React.Component<Props, State> {
  ...
  getImageUrl() {
    ...
    const url = `https://d7hftxdivxxvm.cloudfront.net/?resize_to=${type}&width=${width}&height=${height}&quality=${IMAGE_QUALITY}&src=${encodeURIComponent(imageURL)}` // prettier-ignore
    return url
  }
