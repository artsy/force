...
describe 'FairEvents', ->
  ...
  describe '#sortedEvents', ->
    it 'sorts the events by start_at', ->
      ...
      sorted[0].attributes.name.should.equal 'March third'
      sorted[0].attributes.start_at.should.equal '2014-03-05T17:15:00+00:00'
      sorted[1].attributes.name.should.equal 'Welcome'
      sorted[1].attributes.start_at.should.equal '2014-03-08T17:15:00+00:00'
      sorted[2].attributes.name.should.equal 'March tenth'
      sorted[2].attributes.start_at.should.equal '2014-10-05T17:15:00+00:00'
